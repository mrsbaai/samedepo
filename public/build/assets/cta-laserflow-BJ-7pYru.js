...
`)+`
`+u);const A=R+p+a,T=R+u+o,P=ba(r,r.VERTEX_SHADER,A),w=ba(r,r.FRAGMENT_SHADER,T);r.attachShader(M,P),r.attachShader(M,w),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function D(C){if(i.debug.checkShaderErrors){const z=r.getProgramInfoLog(M)||"",V=r.getShaderInfoLog(P)||"",q=r.getShaderInfoLog(w)||"",Y=z.trim(),X=V.trim(),re=q.trim();let G=!0,Z=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,P,w);else{const ie=wa(r,P,"vertex"),oe=wa(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
Program Info Log: `+Y+`
`+ie+`
`+oe)}else Y!==""?console.warn("THREE.WebGLProgram: Program Info Log:",Y):(X===""||re==="")&&(Z=!1);Z&&(C.diagnostics={runnable:G,programLog:Y,vertexShader:{log:X,prefix:p},fragmentShader:{log:re,prefix:u}})}r.deleteShader(P),r.deleteShader(w),F=new Ki(r,M),S=Xh(r,M)}let F;this.getUniforms=function(){return F===void 0&&D(this),F};let S;this.getAttributes=function(){return S===void 0&&D(this),S};let x=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=r.getProgramParameter(M,Nh)),x},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Oh++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=P,this.fragmentShader=w,this}let id=0;class rd{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new sd(e),t.set(e,n)),n}}class sd{constructor(e){this.id=id++,this.code=e,this.usedTimes=0}}function ad(i,e,t,n,r,s,a){const o=new Ja,c=new rd,l=new Set,f=[],h=r.logarithmicDepthBuffer,d=r.vertexTextures;let m=r.precision;const v={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function M(S){return l.add(S),S===0?"uv":`uv${S}`}function p(S,x,C,z,V){const q=z.fog,Y=V.geometry,X=S.isMeshStandardMaterial?z.environment:null,re=(S.isMeshStandardMaterial?t:e).get(S.envMap||X),G=re&&re.mapping===ji?re.image.height:null,Z=v[S.type];S.precision!==null&&(m=r.getMaxPrecision(S.precision),m!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",m,"instead."));const ie=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,oe=ie!==void 0?ie.length:0;let Le=0;Y.morphAttributes.position!==void 0&&(Le=1),Y.morphAttributes.normal!==void 0&&(Le=2),Y.morphAttributes.color!==void 0&&(Le=3);let He,We,Be,k;if(Z){const Xe=Gt[Z];He=Xe.vertexShader,We=Xe.fragmentShader}else He=S.vertexShader,We=S.fragmentShader,c.update(S),Be=c.getVertexShaderID(S),k=c.getFragmentShaderID(S);const $=i.getRenderTarget(),de=i.state.buffers.depth.getReversed(),Ce=V.isInstancedMesh===!0,Ee=V.isBatchedMesh===!0,Oe=!!S.map,ot=!!S.matcap,y=!!re,Ke=!!S.aoMap,De=!!S.lightMap,Re=!!S.bumpMap,_e=!!S.normalMap,Je=!!S.displacementMap,ge=!!S.emissiveMap,Ie=!!S.metalnessMap,et=!!S.roughnessMap,nt=S.anisotropy>0,E=S.clearcoat>0,_=S.dispersion>0,I=S.iridescence>0,W=S.sheen>0,J=S.transmission>0,H=nt&&!!S.anisotropyMap,Te=E&&!!S.clearcoatMap,ae=E&&!!S.clearcoatNormalMap,xe=E&&!!S.clearcoatRoughnessMap,Se=I&&!!S.iridescenceMap,ee=I&&!!S.iridescenceThicknessMap,j=W&&!!S.sheenColorMap,he=W&&!!S.sheenRoughnessMap,ce=!!S.specularMap,se=!!S.specularColorMap,ye=!!S.specularIntensityMap,b=J&&!!S.transmissionMap,Q=J&&!!S.thicknessMap,le=!!S.gradientMap,me=!!S.alphaMap,te=S.alphaTest>0,K=!!S.alphaHash,Me=!!S.extensions;let Ue=hn;S.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(Ue=i.toneMapping);const Qe={shaderID:Z,shaderType:S.type,shaderName:S.name,vertexShader:He,fragmentShader:We,defines:S.defines,customVertexShaderID:Be,customFragmentShaderID:k,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:m,batching:Ee,batchingColor:Ee&&V._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&V.instanceColor!==null,instancingMorph:Ce&&V.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:$===null?i.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:Qn,alphaToCoverage:!!S.alphaToCoverage,map:Oe,matcap:ot,envMap:y,envMapMode:y&&re.mapping,envMapCubeUVHeight:G,aoMap:Ke,lightMap:De,bumpMap:Re,normalMap:_e,displacementMap:d&&Je,emissiveMap:ge,normalMapObjectSpace:_e&&S.normalMapType===nl,normalMapTangentSpace:_e&&S.normalMapType===tl,metalnessMap:Ie,roughnessMap:et,anisotropy:nt,anisotropyMap:H,clearcoat:E,clearcoatMap:Te,clearcoatNormalMap:ae,clearcoatRoughnessMap:xe,dispersion:_,iridescence:I,iridescenceMap:Se,iridescenceThicknessMap:ee,sheen:W,sheenColorMap:j,sheenRoughnessMap:he,specularMap:ce,specularColorMap:se,specularIntensityMap:ye,transmission:J,transmissionMap:b,thicknessMap:Q,gradientMap:le,opaque:S.transparent===!1&&S.blending===Cn&&S.alphaToCoverage===!1,alphaMap:me,alphaTest:te,alphaHash:K,combine:S.combine,mapUv:Oe&&M(S.map.channel),aoMapUv:Ke&&M(S.aoMap.channel),lightMapUv:De&&M(S.lightMap.channel),bumpMapUv:Re&&M(S.bumpMap.channel),normalMapUv:_e&&M(S.normalMap.channel),displacementMapUv:Je&&M(S.displacementMap.channel),emissiveMapUv:ge&&M(S.emissiveMap.channel),metalnessMapUv:Ie&&M(S.metalnessMap.channel),roughnessMapUv:et&&M(S.roughnessMap.channel),anisotropyMapUv:H&&M(S.anisotropyMap.channel),clearcoatMapUv:Te&&M(S.clearcoatMap.channel),clearcoatNormalMapUv:ae&&M(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:xe&&M(S.clearcoatRoughnessMap.channel),iridescenceMapUv:Se&&M(S.iridescenceMap.channel),iridescenceThicknessMapUv:ee&&M(S.iridescenceThicknessMap.channel),sheenColorMapUv:j&&M(S.sheenColorMap.channel),sheenRoughnessMapUv:he&&M(S.sheenRoughnessMap.channel),specularMapUv:ce&&M(S.specularMap.channel),specularColorMapUv:se&&M(S.specularColorMap.channel),specularIntensityMapUv:ye&&M(S.specularIntensityMap.channel),transmissionMapUv:b&&M(S.transmissionMap.channel),thicknessMapUv:Q&&M(S.thicknessMap.channel),alphaMapUv:me&&M(S.alphaMap.channel),vertexTangents:!!Y.attributes.tangent&&(_e||nt),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,pointsUvs:V.isPoints===!0&&!!Y.attributes.uv&&(Oe||me),fog:!!q,useFog:S.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:S.flatShading===!0&&S.wireframe===!1,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reversedDepthBuffer:de,skinning:V.isSkinnedMesh===!0,morphTargets:Y.morphAttributes.position!==void 0,morphNormals:Y.morphAttributes.normal!==void 0,morphColors:Y.morphAttributes.color!==void 0,morphTargetsCount:oe,morphTextureStride:Le,numDirLights:x.directional.length,numPointLights:x.point.length,numSpotLights:x.spot.length,numSpotLightMaps:x.spotLightMap.length,numRectAreaLights:x.rectArea.length,numHemiLights:x.hemi.length,numDirLightShadows:x.directionalShadowMap.length,numPointLightShadows:x.pointShadowMap.length,numSpotLightShadows:x.spotShadowMap.length,numSpotLightShadowsWithMaps:x.numSpotLightShadowsWithMaps,numLightProbes:x.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&C.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ue,decodeVideoTexture:Oe&&S.map.isVideoTexture===!0&&ke.getTransfer(S.map.colorSpace)===$e,decodeVideoTextureEmissive:ge&&S.emissiveMap.isVideoTexture===!0&&ke.getTransfer(S.emissiveMap.colorSpace)===$e,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Jt,flipSided:S.side===Mt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Me&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Me&&S.extensions.multiDraw===!0||Ee)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return Qe.vertexUv1s=l.has(1),Qe.vertexUv2s=l.has(2),Qe.vertexUv3s=l.has(3),l.clear(),Qe}function u(S){const x=[];if(S.shaderID?x.push(S.shaderID):(x.push(S.customVertexShaderID),x.push(S.customFragmentShaderID)),S.defines!==void 0)for(const C in S.defines)x.push(C),x.push(S.defines[C]);return S.isRawShaderMaterial===!1&&(R(x,S),A(x,S),x.push(i.outputColorSpace)),x.push(S.customProgramCacheKey),x.join()}function R(S,x){S.push(x.precision),S.push(x.outputColorSpace),S.push(x.envMapMode),S.push(x.envMapCubeUVHeight),S.push(x.mapUv),S.push(x.alphaMapUv),S.push(x.lightMapUv),S.push(x.aoMapUv),S.push(x.bumpMapUv),S.push(x.normalMapUv),S.push(x.displacementMapUv),S.push(x.emissiveMapUv),S.push(x.metalnessMapUv),S.push(x.roughnessMapUv),S.push(x.anisotropyMapUv),S.push(x.clearcoatMapUv),S.push(x.clearcoatNormalMapUv),S.push(x.clearcoatRoughnessMapUv),S.push(x.iridescenceMapUv),S.push(x.iridescenceThicknessMapUv),S.push(x.sheenColorMapUv),S.push(x.sheenRoughnessMapUv),S.push(x.specularMapUv),S.push(x.specularColorMapUv),S.push(x.specularIntensityMapUv),S.push(x.transmissionMapUv),S.push(x.thicknessMapUv),S.push(x.combine),S.push(x.fogExp2),S.push(x.sizeAttenuation),S.push(x.morphTargetsCount),S.push(x.morphAttributeCount),S.push(x.numDirLights),S.push(x.numPointLights),S.push(x.numSpotLights),S.push(x.numSpotLightMaps),S.push(x.numHemiLights),S.push(x.numRectAreaLights),S.push(x.numDirLightShadows),S.push(x.numPointLightShadows),S.push(x.numSpotLightShadows),S.push(x.numSpotLightShadowsWithMaps),S.push(x.numLightProbes),S.push(x.shadowMapType),S.push(x.toneMapping),S.push(x.numClippingPlanes),S.push(x.numClipIntersection),S.push(x.depthPacking)}function A(S,x){o.disableAll(),x.supportsVertexTextures&&o.enable(0),x.instancing&&o.enable(1),x.instancingColor&&o.enable(2),x.instancingMorph&&o.enable(3),x.matcap&&o.enable(4),x.envMap&&o.enable(5),x.normalMapObjectSpace&&o.enable(6),x.normalMapTangentSpace&&o.enable(7),x.clearcoat&&o.enable(8),x.iridescence&&o.enable(9),x.alphaTest&&o.enable(10),x.vertexColors&&o.enable(11),x.vertexAlphas&&o.enable(12),x.vertexUv1s&&o.enable(13),x.vertexUv2s&&o.enable(14),x.vertexUv3s&&o.enable(15),x.vertexTangents&&o.enable(16),x.anisotropy&&o.enable(17),x.alphaHash&&o.enable(18),x.batching&&o.enable(19),x.dispersion&&o.enable(20),x.batchingColor&&o.enable(21),x.gradientMap&&o.enable(22),S.push(o.mask),o.disableAll(),x.fog&&o.enable(0),x.useFog&&o.enable(1),x.flatShading&&o.enable(2),x.logarithmicDepthBuffer&&o.enable(3),x.reversedDepthBuffer&&o.enable(4),x.skinning&&o.enable(5),x.morphTargets&&o.enable(6),x.morphNormals&&o.enable(7),x.morphColors&&o.enable(8),x.premultipliedAlpha&&o.enable(9),x.shadowMapEnabled&&o.enable(10),x.doubleSided&&o.enable(11),x.flipSided&&o.enable(12),x.useDepthPacking&&o.enable(13),x.dithering&&o.enable(14),x.transmission&&o.enable(15),x.sheen&&o.enable(16),x.opaque&&o.enable(17),x.pointsUvs&&o.enable(18),x.decodeVideoTexture&&o.enable(19),x.decodeVideoTextureEmissive&&o.enable(20),x.alphaToCoverage&&o.enable(21),S.push(o.mask)}function T(S){const x=v[S.type];let C;if(x){const z=Gt[x];C=Ll.clone(z.uniforms)}else C=S.uniforms;return C}function P(S,x){let C;for(let z=0,V=f.length;z<V;z++){const q=f[z];if(q.cacheKey===x){C=q,++C.usedTimes;break}}return C===void 0&&(C=new nd(i,x,S,s),f.push(C)),C}function w(S){if(--S.usedTimes===0){const x=f.indexOf(S);f[x]=f[f.length-1],f.pop(),S.destroy()}}function D(S){c.remove(S)}function F(){c.dispose()}return{getParameters:p,getProgramCacheKey:u,getUniforms:T,acquireProgram:P,releaseProgram:w,releaseShaderCache:D,programs:f,dispose:F}}function od(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function r(a,o,c){i.get(a)[o]=c}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function ld(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Ua(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Ia(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function a(h,d,m,v,M,p){let u=i[e];return u===void 0?(u={id:h.id,object:h,geometry:d,material:m,groupOrder:v,renderOrder:h.renderOrder,z:M,group:p},i[e]=u):(u.id=h.id,u.object=h,u.geometry=d,u.material=m,u.groupOrder=v,u.renderOrder=h.renderOrder,u.z=M,u.group=p),e++,u}function o(h,d,m,v,M,p){const u=a(h,d,m,v,M,p);m.transmission>0?n.push(u):m.transparent===!0?r.push(u):t.push(u)}function c(h,d,m,v,M,p){const u=a(h,d,m,v,M,p);m.transmission>0?n.unshift(u):m.transparent===!0?r.unshift(u):t.unshift(u)}function l(h,d){t.length>1&&t.sort(h||ld),n.length>1&&n.sort(d||Ua),r.length>1&&r.sort(d||Ua)}function f(){for(let h=e,d=i.length;h<d;h++){const m=i[h];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:o,unshift:c,finish:f,sort:l}}function cd(){let i=new WeakMap;function e(n,r){const s=i.get(n);let a;return s===void 0?(a=new Ia,i.set(n,[a])):r>=s.length?(a=new Ia,s.push(a)):a=s[r],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function ud(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new N,color:new qe};break;case"SpotLight":t={position:new N,direction:new N,color:new qe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new N,color:new qe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new N,skyColor:new qe,groundColor:new qe};break;case"RectAreaLight":t={color:new qe,position:new N,halfWidth:new N,halfHeight:new N};break}return i[e.id]=t,t}}}function fd(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ye};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ye};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ye,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let hd=0;function dd(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function pd(i){const e=new ud,t=fd(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new N);const r=new N,s=new ct,a=new ct;function o(l){let f=0,h=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let m=0,v=0,M=0,p=0,u=0,R=0,A=0,T=0,P=0,w=0,D=0;l.sort(dd);for(let S=0,x=l.length;S<x;S++){const C=l[S],z=C.color,V=C.intensity,q=C.distance,Y=C.shadow&&C.shadow.map?C.shadow.map.texture:null;if(C.isAmbientLight)f+=z.r*V,h+=z.g*V,d+=z.b*V;else if(C.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(C.sh.coefficients[X],V);D++}else if(C.isDirectionalLight){const X=e.get(C);if(X.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const re=C.shadow,G=t.get(C);G.shadowIntensity=re.intensity,G.shadowBias=re.bias,G.shadowNormalBias=re.normalBias,G.shadowRadius=re.radius,G.shadowMapSize=re.mapSize,n.directionalShadow[m]=G,n.directionalShadowMap[m]=Y,n.directionalShadowMatrix[m]=C.shadow.matrix,R++}n.directional[m]=X,m++}else if(C.isSpotLight){const X=e.get(C);X.position.setFromMatrixPosition(C.matrixWorld),X.color.copy(z).multiplyScalar(V),X.distance=q,X.coneCos=Math.cos(C.angle),X.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),X.decay=C.decay,n.spot[M]=X;const re=C.shadow;if(C.map&&(n.spotLightMap[P]=C.map,P++,re.updateMatrices(C),C.castShadow&&w++),n.spotLightMatrix[M]=re.matrix,C.castShadow){const G=t.get(C);G.shadowIntensity=re.intensity,G.shadowBias=re.bias,G.shadowNormalBias=re.normalBias,G.shadowRadius=re.radius,G.shadowMapSize=re.mapSize,n.spotShadow[M]=G,n.spotShadowMap[M]=Y,T++}M++}else if(C.isRectAreaLight){const X=e.get(C);X.color.copy(z).multiplyScalar(V),X.halfWidth.set(C.width*.5,0,0),X.halfHeight.set(0,C.height*.5,0),n.rectArea[p]=X,p++}else if(C.isPointLight){const X=e.get(C);if(X.color.copy(C.color).multiplyScalar(C.intensity),X.distance=C.distance,X.decay=C.decay,C.castShadow){const re=C.shadow,G=t.get(C);G.shadowIntensity=re.intensity,G.shadowBias=re.bias,G.shadowNormalBias=re.normalBias,G.shadowRadius=re.radius,G.shadowMapSize=re.mapSize,G.shadowCameraNear=re.camera.near,G.shadowCameraFar=re.camera.far,n.pointShadow[v]=G,n.pointShadowMap[v]=Y,n.pointShadowMatrix[v]=C.shadow.matrix,A++}n.point[v]=X,v++}else if(C.isHemisphereLight){const X=e.get(C);X.skyColor.copy(C.color).multiplyScalar(V),X.groundColor.copy(C.groundColor).multiplyScalar(V),n.hemi[u]=X,u++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ue.LTC_FLOAT_1,n.rectAreaLTC2=ue.LTC_FLOAT_2):(n.rectAreaLTC1=ue.LTC_HALF_1,n.rectAreaLTC2=ue.LTC_HALF_2)),n.ambient[0]=f,n.ambient[1]=h,n.ambient[2]=d;const F=n.hash;(F.directionalLength!==m||F.pointLength!==v||F.spotLength!==M||F.rectAreaLength!==p||F.hemiLength!==u||F.numDirectionalShadows!==R||F.numPointShadows!==A||F.numSpotShadows!==T||F.numSpotMaps!==P||F.numLightProbes!==D)&&(n.directional.length=m,n.spot.length=M,n.rectArea.length=p,n.point.length=v,n.hemi.length=u,n.directionalShadow.length=R,n.directionalShadowMap.length=R,n.pointShadow.length=A,n.pointShadowMap.length=A,n.spotShadow.length=T,n.spotShadowMap.length=T,n.directionalShadowMatrix.length=R,n.pointShadowMatrix.length=A,n.spotLightMatrix.length=T+P-w,n.spotLightMap.length=P,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=D,F.directionalLength=m,F.pointLength=v,F.spotLength=M,F.rectAreaLength=p,F.hemiLength=u,F.numDirectionalShadows=R,F.numPointShadows=A,F.numSpotShadows=T,F.numSpotMaps=P,F.numLightProbes=D,n.version=hd++)}function c(l,f){let h=0,d=0,m=0,v=0,M=0;const p=f.matrixWorldInverse;for(let u=0,R=l.length;u<R;u++){const A=l[u];if(A.isDirectionalLight){const T=n.directional[h];T.direction.setFromMatrixPosition(A.matrixWorld),r.setFromMatrixPosition(A.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(p),h++}else if(A.isSpotLight){const T=n.spot[m];T.position.setFromMatrixPosition(A.matrixWorld),T.position.applyMatrix4(p),T.direction.setFromMatrixPosition(A.matrixWorld),r.setFromMatrixPosition(A.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(p),m++}else if(A.isRectAreaLight){const T=n.rectArea[v];T.position.setFromMatrixPosition(A.matrixWorld),T.position.applyMatrix4(p),a.identity(),s.copy(A.matrixWorld),s.premultiply(p),a.extractRotation(s),T.halfWidth.set(A.width*.5,0,0),T.halfHeight.set(0,A.height*.5,0),T.halfWidth.applyMatrix4(a),T.halfHeight.applyMatrix4(a),v++}else if(A.isPointLight){const T=n.point[d];T.position.setFromMatrixPosition(A.matrixWorld),T.position.applyMatrix4(p),d++}else if(A.isHemisphereLight){const T=n.hemi[M];T.direction.setFromMatrixPosition(A.matrixWorld),T.direction.transformDirection(p),M++}}}return{setup:o,setupView:c,state:n}}function Fa(i){const e=new pd(i),t=[],n=[];function r(f){l.camera=f,t.length=0,n.length=0}function s(f){t.push(f)}function a(f){n.push(f)}function o(){e.setup(t)}function c(f){e.setupView(t,f)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:l,setupLights:o,setupLightsView:c,pushLight:s,pushShadow:a}}function md(i){let e=new WeakMap;function t(r,s=0){const a=e.get(r);let o;return a===void 0?(o=new Fa(i),e.set(r,[o])):s>=a.length?(o=new Fa(i),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const _d=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function vd(i,e,t){let n=new so;const r=new Ye,s=new Ye,a=new at,o=new kl({depthPacking:el}),c=new Wl,l={},f=t.maxTextureSize,h={[dn]:Mt,[Mt]:dn,[Jt]:Jt},d=new nn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ye},radius:{value:4}},vertexShader:_d,fragmentShader:gd}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const v=new pn;v.setAttribute("position",new Bt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new kt(v,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oa;let u=this.type;this.render=function(w,D,F){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const S=i.getRenderTarget(),x=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),z=i.state;z.setBlending(fn),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const V=u!==$t&&this.type===$t,q=u===$t&&this.type!==$t;for(let Y=0,X=w.length;Y<X;Y++){const re=w[Y],G=re.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",re,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const Z=G.getFrameExtents();if(r.multiply(Z),s.copy(G.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/Z.x),r.x=s.x*Z.x,G.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/Z.y),r.y=s.y*Z.y,G.mapSize.y=s.y)),G.map===null||V===!0||q===!0){const oe=this.type!==$t?{minFilter:Ot,magFilter:Ot}:{};G.map!==null&&G.map.dispose(),G.map=new Ln(r.x,r.y,oe),G.map.texture.name=re.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const ie=G.getViewportCount();for(let oe=0;oe<ie;oe++){const Le=G.getViewport(oe);a.set(s.x*Le.x,s.y*Le.y,s.x*Le.z,s.y*Le.w),z.viewport(a),G.updateMatrices(re,oe),n=G.getFrustum(),T(D,F,G.camera,re,this.type)}G.isPointLightShadow!==!0&&this.type===$t&&R(G,F),G.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(S,x,C)};function R(w,D){const F=e.update(M);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Ln(r.x,r.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(D,null,F,d,M,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(D,null,F,m,M,null)}function A(w,D,F,S){let x=null;const C=F.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)x=C;else if(x=F.isPointLight===!0?c:o,i.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const z=x.uuid,V=D.uuid;let q=l[z];q===void 0&&(q={},l[z]=q);let Y=q[V];Y===void 0&&(Y=x.clone(),q[V]=Y,D.addEventListener("dispose",P)),x=Y}if(x.visible=D.visible,x.wireframe=D.wireframe,S===$t?x.side=D.shadowSide!==null?D.shadowSide:D.side:x.side=D.shadowSide!==null?D.shadowSide:h[D.side],x.alphaMap=D.alphaMap,x.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,x.map=D.map,x.clipShadows=D.clipShadows,x.clippingPlanes=D.clippingPlanes,x.clipIntersection=D.clipIntersection,x.displacementMap=D.displacementMap,x.displacementScale=D.displacementScale,x.displacementBias=D.displacementBias,x.wireframeLinewidth=D.wireframeLinewidth,x.linewidth=D.linewidth,F.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const z=i.properties.get(x);z.light=F}return x}function T(w,D,F,S,x){if(w.visible===!1)return;if(w.layers.test(D.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&x===$t)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,w.matrixWorld);const V=e.update(w),q=w.material;if(Array.isArray(q)){const Y=V.groups;for(let X=0,re=Y.length;X<re;X++){const G=Y[X],Z=q[G.materialIndex];if(Z&&Z.visible){const ie=A(w,Z,S,x);w.onBeforeShadow(i,w,D,F,V,ie,G),i.renderBufferDirect(F,null,V,ie,w,G),w.onAfterShadow(i,w,D,F,V,ie,G)}}}else if(q.visible){const Y=A(w,q,S,x);w.onBeforeShadow(i,w,D,F,V,Y,null),i.renderBufferDirect(F,null,V,Y,w,null),w.onAfterShadow(i,w,D,F,V,Y,null)}}const z=w.children;for(let V=0,q=z.length;V<q;V++)T(z[V],D,F,S,x)}function P(w){w.target.removeEventListener("dispose",P);for(const F in l){const S=l[F],x=w.target.uuid;x in S&&(S[x].dispose(),delete S[x])}}}const xd={[Br]:zr,[Gr]:kr,[Hr]:Wr,[$n]:Vr,[zr]:Br,[kr]:Gr,[Wr]:Hr,[Vr]:$n};function Md(i,e){function t(){let b=!1;const Q=new at;let le=null;const me=new at(0,0,0,0);return{setMask:function(te){le!==te&&!b&&(i.colorMask(te,te,te,te),le=te)},setLocked:function(te){b=te},setClear:function(te,K,Me,Ue,Qe){Qe===!0&&(te*=Ue,K*=Ue,Me*=Ue),Q.set(te,K,Me,Ue),me.equals(Q)===!1&&(i.clearColor(te,K,Me,Ue),me.copy(Q))},reset:function(){b=!1,le=null,me.set(-1,0,0,0)}}}function n(){let b=!1,Q=!1,le=null,me=null,te=null;return{setReversed:function(K){if(Q!==K){const Me=e.get("EXT_clip_control");K?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),Q=K;const Ue=te;te=null,this.setClear(Ue)}},getReversed:function(){return Q},setTest:function(K){K?$(i.DEPTH_TEST):de(i.DEPTH_TEST)},setMask:function(K){le!==K&&!b&&(i.depthMask(K),le=K)},setFunc:function(K){if(Q&&(K=xd[K]),me!==K){switch(K){case Br:i.depthFunc(i.NEVER);break;case zr:i.depthFunc(i.ALWAYS);break;case Gr:i.depthFunc(i.LESS);break;case $n:i.depthFunc(i.LEQUAL);break;case Hr:i.depthFunc(i.EQUAL);break;case Vr:i.depthFunc(i.GEQUAL);break;case kr:i.depthFunc(i.GREATER);break;case Wr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=K}},setLocked:function(K){b=K},setClear:function(K){te!==K&&(Q&&(K=1-K),i.clearDepth(K),te=K)},reset:function(){b=!1,le=null,me=null,te=null,Q=!1}}}function r(){let b=!1,Q=null,le=null,me=null,te=null,K=null,Me=null,Ue=null,Qe=null;return{setTest:function(Xe){b||(Xe?$(i.STENCIL_TEST):de(i.STENCIL_TEST))},setMask:function(Xe){Q!==Xe&&!b&&(i.stencilMask(Xe),Q=Xe)},setFunc:function(Xe,Wt,zt){(le!==Xe||me!==Wt||te!==zt)&&(i.stencilFunc(Xe,Wt,zt),le=Xe,me=Wt,te=zt)},setOp:function(Xe,Wt,zt){(K!==Xe||Me!==Wt||Ue!==zt)&&(i.stencilOp(Xe,Wt,zt),K=Xe,Me=Wt,Ue=zt)},setLocked:function(Xe){b=Xe},setClear:function(Xe){Qe!==Xe&&(i.clearStencil(Xe),Qe=Xe)},reset:function(){b=!1,Q=null,le=null,me=null,te=null,K=null,Me=null,Ue=null,Qe=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let f={},h={},d=new WeakMap,m=[],v=null,M=!1,p=null,u=null,R=null,A=null,T=null,P=null,w=null,D=new qe(0,0,0),F=0,S=!1,x=null,C=null,z=null,V=null,q=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,re=0;const G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(G)[1]),X=re>=1):G.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),X=re>=2);let Z=null,ie={};const oe=i.getParameter(i.SCISSOR_BOX),Le=i.getParameter(i.VIEWPORT),He=new at().fromArray(oe),We=new at().fromArray(Le);function Be(b,Q,le,me){const te=new Uint8Array(4),K=i.createTexture();i.bindTexture(b,K),i.texParameteri(b,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(b,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Me=0;Me<le;Me++)b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY?i.texImage3D(Q,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,te):i.texImage2D(Q+Me,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,te);return K}const k={};k[i.TEXTURE_2D]=Be(i.TEXTURE_2D,i.TEXTURE_2D,1),k[i.TEXTURE_CUBE_MAP]=Be(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),k[i.TEXTURE_2D_ARRAY]=Be(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),k[i.TEXTURE_3D]=Be(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(i.DEPTH_TEST),a.setFunc($n),Re(!1),_e(Hs),$(i.CULL_FACE),Ke(fn);function $(b){f[b]!==!0&&(i.enable(b),f[b]=!0)}function de(b){f[b]!==!1&&(i.disable(b),f[b]=!1)}function Ce(b,Q){return h[b]!==Q?(i.bindFramebuffer(b,Q),h[b]=Q,b===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Q),b===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Q),!0):!1}function Ee(b,Q){let le=m,me=!1;if(b){le=d.get(Q),le===void 0&&(le=[],d.set(Q,le));const te=b.textures;if(le.length!==te.length||le[0]!==i.COLOR_ATTACHMENT0){for(let K=0,Me=te.length;K<Me;K++)le[K]=i.COLOR_ATTACHMENT0+K;le.length=te.length,me=!0}}else le[0]!==i.BACK&&(le[0]=i.BACK,me=!0);me&&i.drawBuffers(le)}function Oe(b){return v!==b?(i.useProgram(b),v=b,!0):!1}const ot={[An]:i.FUNC_ADD,[bo]:i.FUNC_SUBTRACT,[Ro]:i.FUNC_REVERSE_SUBTRACT};ot[wo]=i.MIN,ot[Co]=i.MAX;const y={[Po]:i.ZERO,[Do]:i.ONE,[Lo]:i.SRC_COLOR,[Nr]:i.SRC_ALPHA,[Bo]:i.SRC_ALPHA_SATURATE,[No]:i.DST_COLOR,[Io]:i.DST_ALPHA,[Uo]:i.ONE_MINUS_SRC_COLOR,[Or]:i.ONE_MINUS_SRC_ALPHA,[Oo]:i.ONE_MINUS_DST_COLOR,[Fo]:i.ONE_MINUS_DST_ALPHA,[zo]:i.CONSTANT_COLOR,[Go]:i.ONE_MINUS_CONSTANT_COLOR,[Ho]:i.CONSTANT_ALPHA,[Vo]:i.ONE_MINUS_CONSTANT_ALPHA};function Ke(b,Q,le,me,te,K,Me,Ue,Qe,Xe){if(b===fn){M===!0&&(de(i.BLEND),M=!1);return}if(M===!1&&($(i.BLEND),M=!0),b!==Ao){if(b!==p||Xe!==S){if((u!==An||T!==An)&&(i.blendEquation(i.FUNC_ADD),u=An,T=An),Xe)switch(b){case Cn:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Vs:i.blendFunc(i.ONE,i.ONE);break;case ks:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ws:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",b);break}else switch(b){case Cn:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Vs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ks:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ws:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",b);break}R=null,A=null,P=null,w=null,D.set(0,0,0),F=0,p=b,S=Xe}return}te=te||Q,K=K||le,Me=Me||me,(Q!==u||te!==T)&&(i.blendEquationSeparate(ot[Q],ot[te]),u=Q,T=te),(le!==R||me!==A||K!==P||Me!==w)&&(i.blendFuncSeparate(y[le],y[me],y[K],y[Me]),R=le,A=me,P=K,w=Me),(Ue.equals(D)===!1||Qe!==F)&&(i.blendColor(Ue.r,Ue.g,Ue.b,Qe),D.copy(Ue),F=Qe),p=b,S=!1}function De(b,Q){b.side===Jt?de(i.CULL_FACE):$(i.CULL_FACE);let le=b.side===Mt;Q&&(le=!le),Re(le),b.blending===Cn&&b.transparent===!1?Ke(fn):Ke(b.blending,b.blendEquation,b.blendSrc,b.blendDst,b.blendEquationAlpha,b.blendSrcAlpha,b.blendDstAlpha,b.blendColor,b.blendAlpha,b.premultipliedAlpha),a.setFunc(b.depthFunc),a.setTest(b.depthTest),a.setMask(b.depthWrite),s.setMask(b.colorWrite);const me=b.stencilWrite;o.setTest(me),me&&(o.setMask(b.stencilWriteMask),o.setFunc(b.stencilFunc,b.stencilRef,b.stencilFuncMask),o.setOp(b.stencilFail,b.stencilZFail,b.stencilZPass)),ge(b.polygonOffset,b.polygonOffsetFactor,b.polygonOffsetUnits),b.alphaToCoverage===!0?$(i.SAMPLE_ALPHA_TO_COVERAGE):de(i.SAMPLE_ALPHA_TO_COVERAGE)}function Re(b){x!==b&&(b?i.frontFace(i.CW):i.frontFace(i.CCW),x=b)}function _e(b){b!==Eo?($(i.CULL_FACE),b!==C&&(b===Hs?i.cullFace(i.BACK):b===To?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):de(i.CULL_FACE),C=b}function Je(b){b!==z&&(X&&i.lineWidth(b),z=b)}function ge(b,Q,le){b?($(i.POLYGON_OFFSET_FILL),(V!==Q||q!==le)&&(i.polygonOffset(Q,le),V=Q,q=le)):de(i.POLYGON_OFFSET_FILL)}function Ie(b){b?$(i.SCISSOR_TEST):de(i.SCISSOR_TEST)}function et(b){b===void 0&&(b=i.TEXTURE0+Y-1),Z!==b&&(i.activeTexture(b),Z=b)}function nt(b,Q,le){le===void 0&&(Z===null?le=i.TEXTURE0+Y-1:le=Z);let me=ie[le];me===void 0&&(me={type:void 0,texture:void 0},ie[le]=me),(me.type!==b||me.texture!==Q)&&(Z!==le&&(i.activeTexture(le),Z=le),i.bindTexture(b,Q||k[b]),me.type=b,me.texture=Q)}function E(){const b=ie[Z];b!==void 0&&b.type!==void 0&&(i.bindTexture(b.type,null),b.type=void 0,b.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function I(){try{i.compressedTexImage3D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function W(){try{i.texSubImage2D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function J(){try{i.texSubImage3D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function H(){try{i.compressedTexSubImage2D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function Te(){try{i.compressedTexSubImage3D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function ae(){try{i.texStorage2D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function xe(){try{i.texStorage3D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function Se(){try{i.texImage2D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function ee(){try{i.texImage3D(...arguments)}catch(b){console.error("THREE.WebGLState:",b)}}function j(b){He.equals(b)===!1&&(i.scissor(b.x,b.y,b.z,b.w),He.copy(b))}function he(b){We.equals(b)===!1&&(i.viewport(b.x,b.y,b.z,b.w),We.copy(b))}function ce(b,Q){let le=l.get(Q);le===void 0&&(le=new WeakMap,l.set(Q,le));let me=le.get(b);me===void 0&&(me=i.getUniformBlockIndex(Q,b.name),le.set(b,me))}function se(b,Q){const me=l.get(Q).get(b);c.get(Q)!==me&&(i.uniformBlockBinding(Q,me,b.__bindingPointIndex),c.set(Q,me))}function ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),f={},Z=null,ie={},h={},d=new WeakMap,m=[],v=null,M=!1,p=null,u=null,R=null,A=null,T=null,P=null,w=null,D=new qe(0,0,0),F=0,S=!1,x=null,C=null,z=null,V=null,q=null,He.set(0,0,i.canvas.width,i.canvas.height),We.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:$,disable:de,bindFramebuffer:Ce,drawBuffers:Ee,useProgram:Oe,setBlending:Ke,setMaterial:De,setFlipSided:Re,setCullFace:_e,setLineWidth:Je,setPolygonOffset:ge,setScissorTest:Ie,activeTexture:et,bindTexture:nt,unbindTexture:E,compressedTexImage2D:_,compressedTexImage3D:I,texImage2D:Se,texImage3D:ee,updateUBOMapping:ce,uniformBlockBinding:se,texStorage2D:ae,texStorage3D:xe,texSubImage2D:W,texSubImage3D:J,compressedTexSubImage2D:H,compressedTexSubImage3D:Te,scissor:j,viewport:he,reset:ye}}function Sd(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ye,f=new WeakMap;let h;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(E,_){return m?new OffscreenCanvas(E,_):Ji("canvas")}function M(E,_,I){let W=1;const J=nt(E);if((J.width>I||J.height>I)&&(W=I/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const H=Math.floor(W*J.width),Te=Math.floor(W*J.height);h===void 0&&(h=v(H,Te));const ae=_?v(H,Te):h;return ae.width=H,ae.height=Te,ae.getContext("2d").drawImage(E,0,0,H,Te),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+H+"x"+Te+")."),ae}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),E;return E}function p(E){return E.generateMipmaps}function u(E){i.generateMipmap(E)}function R(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function A(E,_,I,W,J=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let H=_;if(_===i.RED&&(I===i.FLOAT&&(H=i.R32F),I===i.HALF_FLOAT&&(H=i.R16F),I===i.UNSIGNED_BYTE&&(H=i.R8)),_===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.R8UI),I===i.UNSIGNED_SHORT&&(H=i.R16UI),I===i.UNSIGNED_INT&&(H=i.R32UI),I===i.BYTE&&(H=i.R8I),I===i.SHORT&&(H=i.R16I),I===i.INT&&(H=i.R32I)),_===i.RG&&(I===i.FLOAT&&(H=i.RG32F),I===i.HALF_FLOAT&&(H=i.RG16F),I===i.UNSIGNED_BYTE&&(H=i.RG8)),_===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RG8UI),I===i.UNSIGNED_SHORT&&(H=i.RG16UI),I===i.UNSIGNED_INT&&(H=i.RG32UI),I===i.BYTE&&(H=i.RG8I),I===i.SHORT&&(H=i.RG16I),I===i.INT&&(H=i.RG32I)),_===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGB8UI),I===i.UNSIGNED_SHORT&&(H=i.RGB16UI),I===i.UNSIGNED_INT&&(H=i.RGB32UI),I===i.BYTE&&(H=i.RGB8I),I===i.SHORT&&(H=i.RGB16I),I===i.INT&&(H=i.RGB32I)),_===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(H=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(H=i.RGBA16UI),I===i.UNSIGNED_INT&&(H=i.RGBA32UI),I===i.BYTE&&(H=i.RGBA8I),I===i.SHORT&&(H=i.RGBA16I),I===i.INT&&(H=i.RGBA32I)),_===i.RGB&&(I===i.UNSIGNED_INT_5_9_9_9_REV&&(H=i.RGB9_E5),I===i.UNSIGNED_INT_10F_11F_11F_REV&&(H=i.R11F_G11F_B10F)),_===i.RGBA){const Te=J?Zi:ke.getTransfer(W);I===i.FLOAT&&(H=i.RGBA32F),I===i.HALF_FLOAT&&(H=i.RGBA16F),I===i.UNSIGNED_BYTE&&(H=Te===$e?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT_4_4_4_4&&(H=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(H=i.RGB5_A1)}return(H===i.R16F||H===i.R32F||H===i.RG16F||H===i.RG32F||H===i.RGBA16F||H===i.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function T(E,_){let I;return E?_===null||_===Dn||_===fi?I=i.DEPTH24_STENCIL8:_===jt?I=i.DEPTH32F_STENCIL8:_===ui&&(I=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Dn||_===fi?I=i.DEPTH_COMPONENT24:_===jt?I=i.DEPTH_COMPONENT32F:_===ui&&(I=i.DEPTH_COMPONENT16),I}function P(E,_){return p(E)===!0||E.isFramebufferTexture&&E.minFilter!==Ot&&E.minFilter!==Ht?Math.log2(Math.max(_.width,_.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?_.mipmaps.length:1}function w(E){const _=E.target;_.removeEventListener("dispose",w),F(_),_.isVideoTexture&&f.delete(_)}function D(E){const _=E.target;_.removeEventListener("dispose",D),x(_)}function F(E){const _=n.get(E);if(_.__webglInit===void 0)return;const I=E.source,W=d.get(I);if(W){const J=W[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&S(E),Object.keys(W).length===0&&d.delete(I)}n.remove(E)}function S(E){const _=n.get(E);i.deleteTexture(_.__webglTexture);const I=E.source,W=d.get(I);delete W[_.__cacheKey],a.memory.textures--}function x(E){const _=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(_.__webglFramebuffer[W]))for(let J=0;J<_.__webglFramebuffer[W].length;J++)i.deleteFramebuffer(_.__webglFramebuffer[W][J]);else i.deleteFramebuffer(_.__webglFramebuffer[W]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[W])}else{if(Array.isArray(_.__webglFramebuffer))for(let W=0;W<_.__webglFramebuffer.length;W++)i.deleteFramebuffer(_.__webglFramebuffer[W]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let W=0;W<_.__webglColorRenderbuffer.length;W++)_.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[W]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const I=E.textures;for(let W=0,J=I.length;W<J;W++){const H=n.get(I[W]);H.__webglTexture&&(i.deleteTexture(H.__webglTexture),a.memory.textures--),n.remove(I[W])}n.remove(E)}let C=0;function z(){C=0}function V(){const E=C;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),C+=1,E}function q(E){const _=[];return _.push(E.wrapS),_.push(E.wrapT),_.push(E.wrapR||0),_.push(E.magFilter),_.push(E.minFilter),_.push(E.anisotropy),_.push(E.internalFormat),_.push(E.format),_.push(E.type),_.push(E.generateMipmaps),_.push(E.premultiplyAlpha),_.push(E.flipY),_.push(E.unpackAlignment),_.push(E.colorSpace),_.join()}function Y(E,_){const I=n.get(E);if(E.isVideoTexture&&Ie(E),E.isRenderTargetTexture===!1&&E.isExternalTexture!==!0&&E.version>0&&I.__version!==E.version){const W=E.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{k(I,E,_);return}}else E.isExternalTexture&&(I.__webglTexture=E.sourceTexture?E.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+_)}function X(E,_){const I=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){k(I,E,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+_)}function re(E,_){const I=n.get(E);if(E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){k(I,E,_);return}t.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+_)}function G(E,_){const I=n.get(E);if(E.version>0&&I.__version!==E.version){$(I,E,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+_)}const Z={[Yr]:i.REPEAT,[Rn]:i.CLAMP_TO_EDGE,[Kr]:i.MIRRORED_REPEAT},ie={[Ot]:i.NEAREST,[jo]:i.NEAREST_MIPMAP_NEAREST,[Ei]:i.NEAREST_MIPMAP_LINEAR,[Ht]:i.LINEAR,[rr]:i.LINEAR_MIPMAP_NEAREST,[wn]:i.LINEAR_MIPMAP_LINEAR},oe={[il]:i.NEVER,[cl]:i.ALWAYS,[rl]:i.LESS,[Ka]:i.LEQUAL,[sl]:i.EQUAL,[ll]:i.GEQUAL,[al]:i.GREATER,[ol]:i.NOTEQUAL};function Le(E,_){if(_.type===jt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ht||_.magFilter===rr||_.magFilter===Ei||_.magFilter===wn||_.minFilter===Ht||_.minFilter===rr||_.minFilter===Ei||_.minFilter===wn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,Z[_.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,Z[_.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,Z[_.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,ie[_.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,ie[_.minFilter]),_.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,oe[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ot||_.minFilter!==Ei&&_.minFilter!==wn||_.type===jt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function He(E,_){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,_.addEventListener("dispose",w));const W=_.source;let J=d.get(W);J===void 0&&(J={},d.set(W,J));const H=q(_);if(H!==E.__cacheKey){J[H]===void 0&&(J[H]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),J[H].usedTimes++;const Te=J[E.__cacheKey];Te!==void 0&&(J[E.__cacheKey].usedTimes--,Te.usedTimes===0&&S(_)),E.__cacheKey=H,E.__webglTexture=J[H].texture}return I}function We(E,_,I){return Math.floor(Math.floor(E/I)/_)}function Be(E,_,I,W){const H=E.updateRanges;if(H.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,I,W,_.data);else{H.sort((ee,j)=>ee.start-j.start);let Te=0;for(let ee=1;ee<H.length;ee++){const j=H[Te],he=H[ee],ce=j.start+j.count,se=We(he.start,_.width,4),ye=We(j.start,_.width,4);he.start<=ce+1&&se===ye&&We(he.start+he.count-1,_.width,4)===se?j.count=Math.max(j.count,he.start+he.count-j.start):(++Te,H[Te]=he)}H.length=Te+1;const ae=i.getParameter(i.UNPACK_ROW_LENGTH),xe=i.getParameter(i.UNPACK_SKIP_PIXELS),Se=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ee=0,j=H.length;ee<j;ee++){const he=H[ee],ce=Math.floor(he.start/4),se=Math.ceil(he.count/4),ye=ce%_.width,b=Math.floor(ce/_.width),Q=se,le=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,ye),i.pixelStorei(i.UNPACK_SKIP_ROWS,b),t.texSubImage2D(i.TEXTURE_2D,0,ye,b,Q,le,I,W,_.data)}E.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ae),i.pixelStorei(i.UNPACK_SKIP_PIXELS,xe),i.pixelStorei(i.UNPACK_SKIP_ROWS,Se)}}function k(E,_,I){let W=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(W=i.TEXTURE_3D);const J=He(E,_),H=_.source;t.bindTexture(W,E.__webglTexture,i.TEXTURE0+I);const Te=n.get(H);if(H.version!==Te.__version||J===!0){t.activeTexture(i.TEXTURE0+I);const ae=ke.getPrimaries(ke.workingColorSpace),xe=_.colorSpace===un?null:ke.getPrimaries(_.colorSpace),Se=_.colorSpace===un||ae===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);let ee=M(_.image,!1,r.maxTextureSize);ee=et(_,ee);const j=s.convert(_.format,_.colorSpace),he=s.convert(_.type);let ce=A(_.internalFormat,j,he,_.colorSpace,_.isVideoTexture);Le(W,_);let se;const ye=_.mipmaps,b=_.isVideoTexture!==!0,Q=Te.__version===void 0||J===!0,le=H.dataReady,me=P(_,ee);if(_.isDepthTexture)ce=T(_.format===di,_.type),Q&&(b?t.texStorage2D(i.TEXTURE_2D,1,ce,ee.width,ee.height):t.texImage2D(i.TEXTURE_2D,0,ce,ee.width,ee.height,0,j,he,null));else if(_.isDataTexture)if(ye.length>0){b&&Q&&t.texStorage2D(i.TEXTURE_2D,me,ce,ye[0].width,ye[0].height);for(let te=0,K=ye.length;te<K;te++)se=ye[te],b?le&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,j,he,se.data):t.texImage2D(i.TEXTURE_2D,te,ce,se.width,se.height,0,j,he,se.data);_.generateMipmaps=!1}else b?(Q&&t.texStorage2D(i.TEXTURE_2D,me,ce,ee.width,ee.height),le&&Be(_,ee,j,he)):t.texImage2D(i.TEXTURE_2D,0,ce,ee.width,ee.height,0,j,he,ee.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){b&&Q&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,ce,ye[0].width,ye[0].height,ee.depth);for(let te=0,K=ye.length;te<K;te++)if(se=ye[te],_.format!==Nt)if(j!==null)if(b){if(le)if(_.layerUpdates.size>0){const Me=fa(se.width,se.height,_.format,_.type);for(const Ue of _.layerUpdates){const Qe=se.data.subarray(Ue*Me/se.data.BYTES_PER_ELEMENT,(Ue+1)*Me/se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,Ue,se.width,se.height,1,j,Qe)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,se.width,se.height,ee.depth,j,se.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,te,ce,se.width,se.height,ee.depth,0,se.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else b?le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,se.width,se.height,ee.depth,j,he,se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,te,ce,se.width,se.height,ee.depth,0,j,he,se.data)}else{b&&Q&&t.texStorage2D(i.TEXTURE_2D,me,ce,ye[0].width,ye[0].height);for(let te=0,K=ye.length;te<K;te++)se=ye[te],_.format!==Nt?j!==null?b?le&&t.compressedTexSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,j,se.data):t.compressedTexImage2D(i.TEXTURE_2D,te,ce,se.width,se.height,0,se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):b?le&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,j,he,se.data):t.texImage2D(i.TEXTURE_2D,te,ce,se.width,se.height,0,j,he,se.data)}else if(_.isDataArrayTexture)if(b){if(Q&&t.texStorage3D(i.TEXTURE_2D_ARRAY,me,ce,ee.width,ee.height,ee.depth),le)if(_.layerUpdates.size>0){const te=fa(ee.width,ee.height,_.format,_.type);for(const K of _.layerUpdates){const Me=ee.data.subarray(K*te/ee.data.BYTES_PER_ELEMENT,(K+1)*te/ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,K,ee.width,ee.height,1,j,he,Me)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,j,he,ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ce,ee.width,ee.height,ee.depth,0,j,he,ee.data);else if(_.isData3DTexture)b?(Q&&t.texStorage3D(i.TEXTURE_3D,me,ce,ee.width,ee.height,ee.depth),le&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,j,he,ee.data)):t.texImage3D(i.TEXTURE_3D,0,ce,ee.width,ee.height,ee.depth,0,j,he,ee.data);else if(_.isFramebufferTexture){if(Q)if(b)t.texStorage2D(i.TEXTURE_2D,me,ce,ee.width,ee.height);else{let te=ee.width,K=ee.height;for(let Me=0;Me<me;Me++)t.texImage2D(i.TEXTURE_2D,Me,ce,te,K,0,j,he,null),te>>=1,K>>=1}}else if(ye.length>0){if(b&&Q){const te=nt(ye[0]);t.texStorage2D(i.TEXTURE_2D,me,ce,te.width,te.height)}for(let te=0,K=ye.length;te<K;te++)se=ye[te],b?le&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,j,he,se):t.texImage2D(i.TEXTURE_2D,te,ce,j,he,se);_.generateMipmaps=!1}else if(b){if(Q){const te=nt(ee);t.texStorage2D(i.TEXTURE_2D,me,ce,te.width,te.height)}le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,j,he,ee)}else t.texImage2D(i.TEXTURE_2D,0,ce,j,he,ee);p(_)&&u(W),Te.__version=H.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function $(E,_,I){if(_.image.length!==6)return;const W=He(E,_),J=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+I);const H=n.get(J);if(J.version!==H.__version||W===!0){t.activeTexture(i.TEXTURE0+I);const Te=ke.getPrimaries(ke.workingColorSpace),ae=_.colorSpace===un?null:ke.getPrimaries(_.colorSpace),xe=_.colorSpace===un||Te===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);const Se=_.isCompressedTexture||_.image[0].isCompressedTexture,ee=_.image[0]&&_.image[0].isDataTexture,j=[];for(let K=0;K<6;K++)!Se&&!ee?j[K]=M(_.image[K],!0,r.maxCubemapSize):j[K]=ee?_.image[K].image:_.image[K],j[K]=et(_,j[K]);const he=j[0],ce=s.convert(_.format,_.colorSpace),se=s.convert(_.type),ye=A(_.internalFormat,ce,se,_.colorSpace),b=_.isVideoTexture!==!0,Q=H.__version===void 0||W===!0,le=J.dataReady;let me=P(_,he);Le(i.TEXTURE_CUBE_MAP,_);let te;if(Se){b&&Q&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,ye,he.width,he.height);for(let K=0;K<6;K++){te=j[K].mipmaps;for(let Me=0;Me<te.length;Me++){const Ue=te[Me];_.format!==Nt?ce!==null?b?le&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me,0,0,Ue.width,Ue.height,ce,Ue.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me,ye,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):b?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me,0,0,Ue.width,Ue.height,ce,se,Ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me,ye,Ue.width,Ue.height,0,ce,se,Ue.data)}}}else{if(te=_.mipmaps,b&&Q){te.length>0&&me++;const K=nt(j[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,ye,K.width,K.height)}for(let K=0;K<6;K++)if(ee){b?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,j[K].width,j[K].height,ce,se,j[K].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ye,j[K].width,j[K].height,0,ce,se,j[K].data);for(let Me=0;Me<te.length;Me++){const Qe=te[Me].image[K].image;b?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me+1,0,0,Qe.width,Qe.height,ce,se,Qe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me+1,ye,Qe.width,Qe.height,0,ce,se,Qe.data)}}else{b?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ce,se,j[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,ye,ce,se,j[K]);for(let Me=0;Me<te.length;Me++){const Ue=te[Me];b?le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me+1,0,0,ce,se,Ue.image[K]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,Me+1,ye,ce,se,Ue.image[K])}}}p(_)&&u(i.TEXTURE_CUBE_MAP),H.__version=J.version,_.onUpdate&&_.onUpdate(_)}E.__version=_.version}function de(E,_,I,W,J,H){const Te=s.convert(I.format,I.colorSpace),ae=s.convert(I.type),xe=A(I.internalFormat,Te,ae,I.colorSpace),Se=n.get(_),ee=n.get(I);if(ee.__renderTarget=_,!Se.__hasExternalTextures){const j=Math.max(1,_.width>>H),he=Math.max(1,_.height>>H);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?t.texImage3D(J,H,xe,j,he,_.depth,0,Te,ae,null):t.texImage2D(J,H,xe,j,he,0,Te,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,J,ee.__webglTexture,0,Je(_)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,J,ee.__webglTexture,H),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ce(E,_,I){if(i.bindRenderbuffer(i.RENDERBUFFER,E),_.depthBuffer){const W=_.depthTexture,J=W&&W.isDepthTexture?W.type:null,H=T(_.stencilBuffer,J),Te=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=Je(_);ge(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,H,_.width,_.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,H,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,H,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Te,i.RENDERBUFFER,E)}else{const W=_.textures;for(let J=0;J<W.length;J++){const H=W[J],Te=s.convert(H.format,H.colorSpace),ae=s.convert(H.type),xe=A(H.internalFormat,Te,ae,H.colorSpace),Se=Je(_);I&&ge(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Se,xe,_.width,_.height):ge(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Se,xe,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,xe,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ee(E,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const W=n.get(_.depthTexture);W.__renderTarget=_,(!W.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y(_.depthTexture,0);const J=W.__webglTexture,H=Je(_);if(_.depthTexture.format===hi)ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,H):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(_.depthTexture.format===di)ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,H):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Oe(E){const _=n.get(E),I=E.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==E.depthTexture){const W=E.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),W){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=W}if(E.depthTexture&&!_.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");const W=E.texture.mipmaps;W&&W.length>0?Ee(_.__webglFramebuffer[0],E):Ee(_.__webglFramebuffer,E)}else if(I){_.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[W]),_.__webglDepthbuffer[W]===void 0)_.__webglDepthbuffer[W]=i.createRenderbuffer(),Ce(_.__webglDepthbuffer[W],E,!1);else{const J=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=_.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,H)}}else{const W=E.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Ce(_.__webglDepthbuffer,E,!1);else{const J=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,H=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,H),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,H)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function ot(E,_,I){const W=n.get(E);_!==void 0&&de(W.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&Oe(E)}function y(E){const _=E.texture,I=n.get(E),W=n.get(_);E.addEventListener("dispose",D);const J=E.textures,H=E.isWebGLCubeRenderTarget===!0,Te=J.length>1;if(Te||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=_.version,a.memory.textures++),H){I.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer[ae]=[];for(let xe=0;xe<_.mipmaps.length;xe++)I.__webglFramebuffer[ae][xe]=i.createFramebuffer()}else I.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer=[];for(let ae=0;ae<_.mipmaps.length;ae++)I.__webglFramebuffer[ae]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(Te)for(let ae=0,xe=J.length;ae<xe;ae++){const Se=n.get(J[ae]);Se.__webglTexture===void 0&&(Se.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&ge(E)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ae=0;ae<J.length;ae++){const xe=J[ae];I.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[ae]);const Se=s.convert(xe.format,xe.colorSpace),ee=s.convert(xe.type),j=A(xe.internalFormat,Se,ee,xe.colorSpace,E.isXRRenderTarget===!0),he=Je(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,he,j,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,I.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),Ce(I.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(H){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),Le(i.TEXTURE_CUBE_MAP,_);for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0)for(let xe=0;xe<_.mipmaps.length;xe++)de(I.__webglFramebuffer[ae][xe],E,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,xe);else de(I.__webglFramebuffer[ae],E,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(_)&&u(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Te){for(let ae=0,xe=J.length;ae<xe;ae++){const Se=J[ae],ee=n.get(Se);let j=i.TEXTURE_2D;(E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(j=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,ee.__webglTexture),Le(j,Se),de(I.__webglFramebuffer,E,Se,i.COLOR_ATTACHMENT0+ae,j,0),p(Se)&&u(j)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ae=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,W.__webglTexture),Le(ae,_),_.mipmaps&&_.mipmaps.length>0)for(let xe=0;xe<_.mipmaps.length;xe++)de(I.__webglFramebuffer[xe],E,_,i.COLOR_ATTACHMENT0,ae,xe);else de(I.__webglFramebuffer,E,_,i.COLOR_ATTACHMENT0,ae,0);p(_)&&u(ae),t.unbindTexture()}E.depthBuffer&&Oe(E)}function Ke(E){const _=E.textures;for(let I=0,W=_.length;I<W;I++){const J=_[I];if(p(J)){const H=R(E),Te=n.get(J).__webglTexture;t.bindTexture(H,Te),u(H),t.unbindTexture()}}}const De=[],Re=[];function _e(E){if(E.samples>0){if(ge(E)===!1){const _=E.textures,I=E.width,W=E.height;let J=i.COLOR_BUFFER_BIT;const H=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Te=n.get(E),ae=_.length>1;if(ae)for(let Se=0;Se<_.length;Se++)t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Te.__webglMultisampledFramebuffer);const xe=E.texture.mipmaps;xe&&xe.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglFramebuffer);for(let Se=0;Se<_.length;Se++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Te.__webglColorRenderbuffer[Se]);const ee=n.get(_[Se]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ee,0)}i.blitFramebuffer(0,0,I,W,0,0,I,W,J,i.NEAREST),c===!0&&(De.length=0,Re.length=0,De.push(i.COLOR_ATTACHMENT0+Se),E.depthBuffer&&E.resolveDepthBuffer===!1&&(De.push(H),Re.push(H),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Re)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,De))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let Se=0;Se<_.length;Se++){t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.RENDERBUFFER,Te.__webglColorRenderbuffer[Se]);const ee=n.get(_[Se]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Te.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Se,i.TEXTURE_2D,ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Te.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const _=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Je(E){return Math.min(r.maxSamples,E.samples)}function ge(E){const _=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Ie(E){const _=a.render.frame;f.get(E)!==_&&(f.set(E,_),E.update())}function et(E,_){const I=E.colorSpace,W=E.format,J=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||I!==Qn&&I!==un&&(ke.getTransfer(I)===$e?(W!==Nt||J!==en)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),_}function nt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=V,this.resetTextureUnits=z,this.setTexture2D=Y,this.setTexture2DArray=X,this.setTexture3D=re,this.setTextureCube=G,this.rebindTextures=ot,this.setupRenderTarget=y,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=_e,this.setupDepthRenderbuffer=Oe,this.setupFrameBufferTexture=de,this.useMultisampledRTT=ge}function Ed(i,e){function t(n,r=un){let s;const a=ke.getTransfer(r);if(n===en)return i.UNSIGNED_BYTE;if(n===Rs)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ws)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Va)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ka)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Ga)return i.BYTE;if(n===Ha)return i.SHORT;if(n===ui)return i.UNSIGNED_SHORT;if(n===bs)return i.INT;if(n===Dn)return i.UNSIGNED_INT;if(n===jt)return i.FLOAT;if(n===mi)return i.HALF_FLOAT;if(n===Wa)return i.ALPHA;if(n===Xa)return i.RGB;if(n===Nt)return i.RGBA;if(n===hi)return i.DEPTH_COMPONENT;if(n===di)return i.DEPTH_STENCIL;if(n===qa)return i.RED;if(n===Cs)return i.RED_INTEGER;if(n===Ya)return i.RG;if(n===Ps)return i.RG_INTEGER;if(n===Ds)return i.RGBA_INTEGER;if(n===Wi||n===Xi||n===qi||n===Yi)if(a===$e)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Wi)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Xi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===qi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Yi)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Wi)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Xi)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===qi)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Yi)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Zr||n===$r||n===Jr||n===jr)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Zr)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===$r)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Jr)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===jr)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Qr||n===es||n===ts)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Qr||n===es)return a===$e?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ts)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ns||n===is||n===rs||n===ss||n===as||n===os||n===ls||n===cs||n===us||n===fs||n===hs||n===ds||n===ps||n===ms)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===ns)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===is)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===rs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ss)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===as)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===os)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ls)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===cs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===us)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===fs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===hs)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ds)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ps)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ms)return a===$e?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===_s||n===gs||n===vs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===_s)return a===$e?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===gs)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===vs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===xs||n===Ms||n===Ss||n===Es)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===xs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ms)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ss)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Es)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===fi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Td=`
void main() {
...
}`;class Ad{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new oo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new nn({vertexShader:Td,fragmentShader:yd,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new kt(new er(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class bd extends ti{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,f=null,h=null,d=null,m=null,v=null;const M=typeof XRWebGLBinding<"u",p=new Ad,u={},R=t.getContextAttributes();let A=null,T=null;const P=[],w=[],D=new Ye;let F=null;const S=new It;S.viewport=new at;const x=new It;x.viewport=new at;const C=[S,x],z=new Xl;let V=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let $=P[k];return $===void 0&&($=new Rr,P[k]=$),$.getTargetRaySpace()},this.getControllerGrip=function(k){let $=P[k];return $===void 0&&($=new Rr,P[k]=$),$.getGripSpace()},this.getHand=function(k){let $=P[k];return $===void 0&&($=new Rr,P[k]=$),$.getHandSpace()};function Y(k){const $=w.indexOf(k.inputSource);if($===-1)return;const de=P[$];de!==void 0&&(de.update(k.inputSource,k.frame,l||a),de.dispatchEvent({type:k.type,data:k.inputSource}))}function X(){r.removeEventListener("select",Y),r.removeEventListener("selectstart",Y),r.removeEventListener("selectend",Y),r.removeEventListener("squeeze",Y),r.removeEventListener("squeezestart",Y),r.removeEventListener("squeezeend",Y),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",re);for(let k=0;k<P.length;k++){const $=w[k];$!==null&&(w[k]=null,P[k].disconnect($))}V=null,q=null,p.reset();for(const k in u)delete u[k];e.setRenderTarget(A),m=null,d=null,h=null,r=null,T=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(F),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){s=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){o=k,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(k){l=k},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return h===null&&M&&(h=new XRWebGLBinding(r,t)),h},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(k){if(r=k,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",Y),r.addEventListener("selectstart",Y),r.addEventListener("selectend",Y),r.addEventListener("squeeze",Y),r.addEventListener("squeezestart",Y),r.addEventListener("squeezeend",Y),r.addEventListener("end",X),r.addEventListener("inputsourceschange",re),R.xrCompatible!==!0&&await t.makeXRCompatible(),F=e.getPixelRatio(),e.getSize(D),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let de=null,Ce=null,Ee=null;R.depth&&(Ee=R.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,de=R.stencil?di:hi,Ce=R.stencil?fi:Dn);const Oe={colorFormat:t.RGBA8,depthFormat:Ee,scaleFactor:s};h=this.getBinding(),d=h.createProjectionLayer(Oe),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),T=new Ln(d.textureWidth,d.textureHeight,{format:Nt,type:en,depthTexture:new ao(d.textureWidth,d.textureHeight,Ce,void 0,void 0,void 0,void 0,void 0,void 0,de),stencilBuffer:R.stencil,colorSpace:e.outputColorSpace,samples:R.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const de={antialias:R.antialias,alpha:!0,depth:R.depth,stencil:R.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,de),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),T=new Ln(m.framebufferWidth,m.framebufferHeight,{format:Nt,type:en,colorSpace:e.outputColorSpace,stencilBuffer:R.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Be.setContext(r),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function re(k){for(let $=0;$<k.removed.length;$++){const de=k.removed[$],Ce=w.indexOf(de);Ce>=0&&(w[Ce]=null,P[Ce].disconnect(de))}for(let $=0;$<k.added.length;$++){const de=k.added[$];let Ce=w.indexOf(de);if(Ce===-1){for(let Oe=0;Oe<P.length;Oe++)if(Oe>=w.length){w.push(de),Ce=Oe;break}else if(w[Oe]===null){w[Oe]=de,Ce=Oe;break}if(Ce===-1)break}const Ee=P[Ce];Ee&&Ee.connect(de)}}const G=new N,Z=new N;function ie(k,$,de){G.setFromMatrixPosition($.matrixWorld),Z.setFromMatrixPosition(de.matrixWorld);const Ce=G.distanceTo(Z),Ee=$.projectionMatrix.elements,Oe=de.projectionMatrix.elements,ot=Ee[14]/(Ee[10]-1),y=Ee[14]/(Ee[10]+1),Ke=(Ee[9]+1)/Ee[5],De=(Ee[9]-1)/Ee[5],Re=(Ee[8]-1)/Ee[0],_e=(Oe[8]+1)/Oe[0],Je=ot*Re,ge=ot*_e,Ie=Ce/(-Re+_e),et=Ie*-Re;if($.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(et),k.translateZ(Ie),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),Ee[10]===-1)k.projectionMatrix.copy($.projectionMatrix),k.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const nt=ot+Ie,E=y+Ie,_=Je-et,I=ge+(Ce-et),W=Ke*y/E*nt,J=De*y/E*nt;k.projectionMatrix.makePerspective(_,I,W,J,nt,E),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function oe(k,$){$===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices($.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(r===null)return;let $=k.near,de=k.far;p.texture!==null&&(p.depthNear>0&&($=p.depthNear),p.depthFar>0&&(de=p.depthFar)),z.near=x.near=S.near=$,z.far=x.far=S.far=de,(V!==z.near||q!==z.far)&&(r.updateRenderState({depthNear:z.near,depthFar:z.far}),V=z.near,q=z.far),z.layers.mask=k.layers.mask|6,S.layers.mask=z.layers.mask&3,x.layers.mask=z.layers.mask&5;const Ce=k.parent,Ee=z.cameras;oe(z,Ce);for(let Oe=0;Oe<Ee.length;Oe++)oe(Ee[Oe],Ce);Ee.length===2?ie(z,S,x):z.projectionMatrix.copy(S.projectionMatrix),Le(k,z,Ce)};function Le(k,$,de){de===null?k.matrix.copy($.matrixWorld):(k.matrix.copy(de.matrixWorld),k.matrix.invert(),k.matrix.multiply($.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy($.projectionMatrix),k.projectionMatrixInverse.copy($.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=Ts*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(d===null&&m===null))return c},this.setFoveation=function(k){c=k,d!==null&&(d.fixedFoveation=k),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=k)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(z)},this.getCameraTexture=function(k){return u[k]};let He=null;function We(k,$){if(f=$.getViewerPose(l||a),v=$,f!==null){const de=f.views;m!==null&&(e.setRenderTargetFramebuffer(T,m.framebuffer),e.setRenderTarget(T));let Ce=!1;de.length!==z.cameras.length&&(z.cameras.length=0,Ce=!0);for(let y=0;y<de.length;y++){const Ke=de[y];let De=null;if(m!==null)De=m.getViewport(Ke);else{const _e=h.getViewSubImage(d,Ke);De=_e.viewport,y===0&&(e.setRenderTargetTextures(T,_e.colorTexture,_e.depthStencilTexture),e.setRenderTarget(T))}let Re=C[y];Re===void 0&&(Re=new It,Re.layers.enable(y),Re.viewport=new at,C[y]=Re),Re.matrix.fromArray(Ke.transform.matrix),Re.matrix.decompose(Re.position,Re.quaternion,Re.scale),Re.projectionMatrix.fromArray(Ke.projectionMatrix),Re.projectionMatrixInverse.copy(Re.projectionMatrix).invert(),Re.viewport.set(De.x,De.y,De.width,De.height),y===0&&(z.matrix.copy(Re.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),Ce===!0&&z.cameras.push(Re)}const Ee=r.enabledFeatures;if(Ee&&Ee.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){h=n.getBinding();const y=h.getDepthInformation(de[0]);y&&y.isValid&&y.texture&&p.init(y,r.renderState)}if(Ee&&Ee.includes("camera-access")&&M){e.state.unbindTexture(),h=n.getBinding();for(let y=0;y<de.length;y++){const Ke=de[y].camera;if(Ke){let De=u[Ke];De||(De=new oo,u[Ke]=De);const Re=h.getCameraImage(Ke);De.sourceTexture=Re}}}}for(let de=0;de<P.length;de++){const Ce=w[de],Ee=P[de];Ce!==null&&Ee!==void 0&&Ee.update(Ce,$,l||a)}He&&He(k,$),$.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:$}),v=null}const Be=new co;Be.setAnimationLoop(We),this.setAnimationLoop=function(k){He=k},this.dispose=function(){}}}const En=new tn,Rd=new ct;function wd(i,e){function t(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function n(p,u){u.color.getRGB(p.fogColor.value,no(i)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,R,A,T){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),h(p,u)):u.isMeshPhongMaterial?(s(p,u),f(p,u)):u.isMeshStandardMaterial?(s(p,u),d(p,u),u.isMeshPhysicalMaterial&&m(p,u,T)):u.isMeshMatcapMaterial?(s(p,u),v(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),M(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?c(p,u,R,A):u.isSpriteMaterial?l(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,t(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Mt&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,t(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Mt&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,t(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,t(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const R=e.get(u),A=R.envMap,T=R.envMapRotation;A&&(p.envMap.value=A,En.copy(T),En.x*=-1,En.y*=-1,En.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(En.y*=-1,En.z*=-1),p.envMapRotation.value.setFromMatrix4(Rd.makeRotationFromEuler(En)),p.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function c(p,u,R,A){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*R,p.scale.value=A*.5,u.map&&(p.map.value=u.map,t(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function l(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function f(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function h(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function d(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,R){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Mt&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=R.texture,p.transmissionSamplerSize.value.set(R.width,R.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,u){u.matcap&&(p.matcap.value=u.matcap)}function M(p,u){const R=e.get(u).light;p.referencePosition.value.setFromMatrixPosition(R.matrixWorld),p.nearDistance.value=R.shadow.camera.near,p.farDistance.value=R.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Cd(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(R,A){const T=A.program;n.uniformBlockBinding(R,T)}function l(R,A){let T=r[R.id];T===void 0&&(v(R),T=f(R),r[R.id]=T,R.addEventListener("dispose",p));const P=A.program;n.updateUBOMapping(R,P);const w=e.render.frame;s[R.id]!==w&&(d(R),s[R.id]=w)}function f(R){const A=h();R.__bindingPointIndex=A;const T=i.createBuffer(),P=R.__size,w=R.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,P,w),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,T),T}function h(){for(let R=0;R<o;R++)if(a.indexOf(R)===-1)return a.push(R),R;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(R){const A=r[R.id],T=R.uniforms,P=R.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let w=0,D=T.length;w<D;w++){const F=Array.isArray(T[w])?T[w]:[T[w]];for(let S=0,x=F.length;S<x;S++){const C=F[S];if(m(C,w,S,P)===!0){const z=C.__offset,V=Array.isArray(C.value)?C.value:[C.value];let q=0;for(let Y=0;Y<V.length;Y++){const X=V[Y],re=M(X);typeof X=="number"||typeof X=="boolean"?(C.__data[0]=X,i.bufferSubData(i.UNIFORM_BUFFER,z+q,C.__data)):X.isMatrix3?(C.__data[0]=X.elements[0],C.__data[1]=X.elements[1],C.__data[2]=X.elements[2],C.__data[3]=0,C.__data[4]=X.elements[3],C.__data[5]=X.elements[4],C.__data[6]=X.elements[5],C.__data[7]=0,C.__data[8]=X.elements[6],C.__data[9]=X.elements[7],C.__data[10]=X.elements[8],C.__data[11]=0):(X.toArray(C.__data,q),q+=re.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,z,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(R,A,T,P){const w=R.value,D=A+"_"+T;if(P[D]===void 0)return typeof w=="number"||typeof w=="boolean"?P[D]=w:P[D]=w.clone(),!0;{const F=P[D];if(typeof w=="number"||typeof w=="boolean"){if(F!==w)return P[D]=w,!0}else if(F.equals(w)===!1)return F.copy(w),!0}return!1}function v(R){const A=R.uniforms;let T=0;const P=16;for(let D=0,F=A.length;D<F;D++){const S=Array.isArray(A[D])?A[D]:[A[D]];for(let x=0,C=S.length;x<C;x++){const z=S[x],V=Array.isArray(z.value)?z.value:[z.value];for(let q=0,Y=V.length;q<Y;q++){const X=V[q],re=M(X),G=T%P,Z=G%re.boundary,ie=G+Z;T+=Z,ie!==0&&P-ie<re.storage&&(T+=P-ie),z.__data=new Float32Array(re.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=T,T+=re.storage}}}const w=T%P;return w>0&&(T+=P-w),R.__size=T,R.__cache={},this}function M(R){const A={boundary:0,storage:0};return typeof R=="number"||typeof R=="boolean"?(A.boundary=4,A.storage=4):R.isVector2?(A.boundary=8,A.storage=8):R.isVector3||R.isColor?(A.boundary=16,A.storage=12):R.isVector4?(A.boundary=16,A.storage=16):R.isMatrix3?(A.boundary=48,A.storage=48):R.isMatrix4?(A.boundary=64,A.storage=64):R.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",R),A}function p(R){const A=R.target;A.removeEventListener("dispose",p);const T=a.indexOf(A.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function u(){for(const R in r)i.deleteBuffer(r[R]);a=[],r={},s={}}return{bind:c,update:l,dispose:u}}class Pd{constructor(e={}){const{canvas:t=fl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const v=new Uint32Array(4),M=new Int32Array(4);let p=null,u=null;const R=[],A=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=hn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const T=this;let P=!1;this._outputColorSpace=bt;let w=0,D=0,F=null,S=-1,x=null;const C=new at,z=new at;let V=null;const q=new qe(0);let Y=0,X=t.width,re=t.height,G=1,Z=null,ie=null;const oe=new at(0,0,X,re),Le=new at(0,0,X,re);let He=!1;const We=new so;let Be=!1,k=!1;const $=new ct,de=new N,Ce=new at,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Oe=!1;function ot(){return F===null?G:1}let y=n;function Ke(g,L){return t.getContext(g,L)}try{const g={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${As}`),t.addEventListener("webglcontextlost",le,!1),t.addEventListener("webglcontextrestored",me,!1),t.addEventListener("webglcontextcreationerror",te,!1),y===null){const L="webgl2";if(y=Ke(L,g),y===null)throw Ke(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(g){throw console.error("THREE.WebGLRenderer: "+g.message),g}let De,Re,_e,Je,ge,Ie,et,nt,E,_,I,W,J,H,Te,ae,xe,Se,ee,j,he,ce,se,ye;function b(){De=new Gf(y),De.init(),ce=new Ed(y,De),Re=new Uf(y,De,e,ce),_e=new Md(y,De),Re.reversedDepthBuffer&&d&&_e.buffers.depth.setReversed(!0),Je=new kf(y),ge=new od,Ie=new Sd(y,De,_e,ge,Re,ce,Je),et=new Ff(T),nt=new zf(T),E=new Kl(y),se=new Df(y,E),_=new Hf(y,E,Je,se),I=new Xf(y,_,E,Je),ee=new Wf(y,Re,Ie),ae=new If(ge),W=new ad(T,et,nt,De,Re,se,ae),J=new wd(T,ge),H=new cd,Te=new md(De),Se=new Pf(T,et,nt,_e,I,m,c),xe=new vd(T,I,Re),ye=new Cd(y,Je,Re,_e),j=new Lf(y,De,Je),he=new Vf(y,De,Je),Je.programs=W.programs,T.capabilities=Re,T.extensions=De,T.properties=ge,T.renderLists=H,T.shadowMap=xe,T.state=_e,T.info=Je}b();const Q=new bd(T,y);this.xr=Q,this.getContext=function(){return y},this.getContextAttributes=function(){return y.getContextAttributes()},this.forceContextLoss=function(){const g=De.get("WEBGL_lose_context");g&&g.loseContext()},this.forceContextRestore=function(){const g=De.get("WEBGL_lose_context");g&&g.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(g){g!==void 0&&(G=g,this.setSize(X,re,!1))},this.getSize=function(g){return g.set(X,re)},this.setSize=function(g,L,O=!0){if(Q.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=g,re=L,t.width=Math.floor(g*G),t.height=Math.floor(L*G),O===!0&&(t.style.width=g+"px",t.style.height=L+"px"),this.setViewport(0,0,g,L)},this.getDrawingBufferSize=function(g){return g.set(X*G,re*G).floor()},this.setDrawingBufferSize=function(g,L,O){X=g,re=L,G=O,t.width=Math.floor(g*O),t.height=Math.floor(L*O),this.setViewport(0,0,g,L)},this.getCurrentViewport=function(g){return g.copy(C)},this.getViewport=function(g){return g.copy(oe)},this.setViewport=function(g,L,O,B){g.isVector4?oe.set(g.x,g.y,g.z,g.w):oe.set(g,L,O,B),_e.viewport(C.copy(oe).multiplyScalar(G).round())},this.getScissor=function(g){return g.copy(Le)},this.setScissor=function(g,L,O,B){g.isVector4?Le.set(g.x,g.y,g.z,g.w):Le.set(g,L,O,B),_e.scissor(z.copy(Le).multiplyScalar(G).round())},this.getScissorTest=function(){return He},this.setScissorTest=function(g){_e.setScissorTest(He=g)},this.setOpaqueSort=function(g){Z=g},this.setTransparentSort=function(g){ie=g},this.getClearColor=function(g){return g.copy(Se.getClearColor())},this.setClearColor=function(){Se.setClearColor(...arguments)},this.getClearAlpha=function(){return Se.getClearAlpha()},this.setClearAlpha=function(){Se.setClearAlpha(...arguments)},this.clear=function(g=!0,L=!0,O=!0){let B=0;if(g){let U=!1;if(F!==null){const ne=F.texture.format;U=ne===Ds||ne===Ps||ne===Cs}if(U){const ne=F.texture.type,fe=ne===en||ne===Dn||ne===ui||ne===fi||ne===Rs||ne===ws,ve=Se.getClearColor(),pe=Se.getClearAlpha(),we=ve.r,Pe=ve.g,Ae=ve.b;fe?(v[0]=we,v[1]=Pe,v[2]=Ae,v[3]=pe,y.clearBufferuiv(y.COLOR,0,v)):(M[0]=we,M[1]=Pe,M[2]=Ae,M[3]=pe,y.clearBufferiv(y.COLOR,0,M))}else B|=y.COLOR_BUFFER_BIT}L&&(B|=y.DEPTH_BUFFER_BIT),O&&(B|=y.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),y.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",le,!1),t.removeEventListener("webglcontextrestored",me,!1),t.removeEventListener("webglcontextcreationerror",te,!1),Se.dispose(),H.dispose(),Te.dispose(),ge.dispose(),et.dispose(),nt.dispose(),I.dispose(),se.dispose(),ye.dispose(),W.dispose(),Q.dispose(),Q.removeEventListener("sessionstart",zt),Q.removeEventListener("sessionend",Fs),mn.stop()};function le(g){g.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),P=!0}function me(){console.log("THREE.WebGLRenderer: Context Restored."),P=!1;const g=Je.autoReset,L=xe.enabled,O=xe.autoUpdate,B=xe.needsUpdate,U=xe.type;b(),Je.autoReset=g,xe.enabled=L,xe.autoUpdate=O,xe.needsUpdate=B,xe.type=U}function te(g){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",g.statusMessage)}function K(g){const L=g.target;L.removeEventListener("dispose",K),Me(L)}function Me(g){Ue(g),ge.remove(g)}function Ue(g){const L=ge.get(g).programs;L!==void 0&&(L.forEach(function(O){W.releaseProgram(O)}),g.isShaderMaterial&&W.releaseShaderCache(g))}this.renderBufferDirect=function(g,L,O,B,U,ne){L===null&&(L=Ee);const fe=U.isMesh&&U.matrixWorld.determinant()<0,ve=mo(g,L,O,B,U);_e.setMaterial(B,fe);let pe=O.index,we=1;if(B.wireframe===!0){if(pe=_.getWireframeAttribute(O),pe===void 0)return;we=2}const Pe=O.drawRange,Ae=O.attributes.position;let ze=Pe.start*we,Ze=(Pe.start+Pe.count)*we;ne!==null&&(ze=Math.max(ze,ne.start*we),Ze=Math.min(Ze,(ne.start+ne.count)*we)),pe!==null?(ze=Math.max(ze,0),Ze=Math.min(Ze,pe.count)):Ae!=null&&(ze=Math.max(ze,0),Ze=Math.min(Ze,Ae.count));const st=Ze-ze;if(st<0||st===1/0)return;se.setup(U,B,ve,O,pe);let tt,je=j;if(pe!==null&&(tt=E.get(pe),je=he,je.setIndex(tt)),U.isMesh)B.wireframe===!0?(_e.setLineWidth(B.wireframeLinewidth*ot()),je.setMode(y.LINES)):je.setMode(y.TRIANGLES);else if(U.isLine){let be=B.linewidth;be===void 0&&(be=1),_e.setLineWidth(be*ot()),U.isLineSegments?je.setMode(y.LINES):U.isLineLoop?je.setMode(y.LINE_LOOP):je.setMode(y.LINE_STRIP)}else U.isPoints?je.setMode(y.POINTS):U.isSprite&&je.setMode(y.TRIANGLES);if(U.isBatchedMesh)if(U._multiDrawInstances!==null)pi("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),je.renderMultiDrawInstances(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount,U._multiDrawInstances);else if(De.get("WEBGL_multi_draw"))je.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else{const be=U._multiDrawStarts,it=U._multiDrawCounts,Ve=U._multiDrawCount,Et=pe?E.get(pe).bytesPerElement:1,Un=ge.get(B).currentProgram.getUniforms();for(let Tt=0;Tt<Ve;Tt++)Un.setValue(y,"_gl_DrawID",Tt),je.render(be[Tt]/Et,it[Tt])}else if(U.isInstancedMesh)je.renderInstances(ze,st,U.count);else if(O.isInstancedBufferGeometry){const be=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,it=Math.min(O.instanceCount,be);je.renderInstances(ze,st,it)}else je.render(ze,st)};function Qe(g,L,O){g.transparent===!0&&g.side===Jt&&g.forceSinglePass===!1?(g.side=Mt,g.needsUpdate=!0,Si(g,L,O),g.side=dn,g.needsUpdate=!0,Si(g,L,O),g.side=Jt):Si(g,L,O)}this.compile=function(g,L,O=null){O===null&&(O=g),u=Te.get(O),u.init(L),A.push(u),O.traverseVisible(function(U){U.isLight&&U.layers.test(L.layers)&&(u.pushLight(U),U.castShadow&&u.pushShadow(U))}),g!==O&&g.traverseVisible(function(U){U.isLight&&U.layers.test(L.layers)&&(u.pushLight(U),U.castShadow&&u.pushShadow(U))}),u.setupLights();const B=new Set;return g.traverse(function(U){if(!(U.isMesh||U.isPoints||U.isLine||U.isSprite))return;const ne=U.material;if(ne)if(Array.isArray(ne))for(let fe=0;fe<ne.length;fe++){const ve=ne[fe];Qe(ve,O,U),B.add(ve)}else Qe(ne,O,U),B.add(ne)}),u=A.pop(),B},this.compileAsync=function(g,L,O=null){const B=this.compile(g,L,O);return new Promise(U=>{function ne(){if(B.forEach(function(fe){ge.get(fe).currentProgram.isReady()&&B.delete(fe)}),B.size===0){U(g);return}setTimeout(ne,10)}De.get("KHR_parallel_shader_compile")!==null?ne():setTimeout(ne,10)})};let Xe=null;function Wt(g){Xe&&Xe(g)}function zt(){mn.stop()}function Fs(){mn.start()}const mn=new co;mn.setAnimationLoop(Wt),typeof self<"u"&&mn.setContext(self),this.setAnimationLoop=function(g){Xe=g,Q.setAnimationLoop(g),g===null?mn.stop():mn.start()},Q.addEventListener("sessionstart",zt),Q.addEventListener("sessionend",Fs),this.render=function(g,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;if(g.matrixWorldAutoUpdate===!0&&g.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),Q.enabled===!0&&Q.isPresenting===!0&&(Q.cameraAutoUpdate===!0&&Q.updateCamera(L),L=Q.getCamera()),g.isScene===!0&&g.onBeforeRender(T,g,L,F),u=Te.get(g,A.length),u.init(L),A.push(u),$.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),We.setFromProjectionMatrix($,Vt,L.reversedDepth),k=this.localClippingEnabled,Be=ae.init(this.clippingPlanes,k),p=H.get(g,R.length),p.init(),R.push(p),Q.enabled===!0&&Q.isPresenting===!0){const ne=T.xr.getDepthSensingMesh();ne!==null&&nr(ne,L,-1/0,T.sortObjects)}nr(g,L,0,T.sortObjects),p.finish(),T.sortObjects===!0&&p.sort(Z,ie),Oe=Q.enabled===!1||Q.isPresenting===!1||Q.hasDepthSensing()===!1,Oe&&Se.addToRenderList(p,g),this.info.render.frame++,Be===!0&&ae.beginShadows();const O=u.state.shadowsArray;xe.render(O,g,L),Be===!0&&ae.endShadows(),this.info.autoReset===!0&&this.info.reset();const B=p.opaque,U=p.transmissive;if(u.setupLights(),L.isArrayCamera){const ne=L.cameras;if(U.length>0)for(let fe=0,ve=ne.length;fe<ve;fe++){const pe=ne[fe];Os(B,U,g,pe)}Oe&&Se.render(g);for(let fe=0,ve=ne.length;fe<ve;fe++){const pe=ne[fe];Ns(p,g,pe,pe.viewport)}}else U.length>0&&Os(B,U,g,L),Oe&&Se.render(g),Ns(p,g,L);F!==null&&D===0&&(Ie.updateMultisampleRenderTarget(F),Ie.updateRenderTargetMipmap(F)),g.isScene===!0&&g.onAfterRender(T,g,L),se.resetDefaultState(),S=-1,x=null,A.pop(),A.length>0?(u=A[A.length-1],Be===!0&&ae.setGlobalState(T.clippingPlanes,u.state.camera)):u=null,R.pop(),R.length>0?p=R[R.length-1]:p=null};function nr(g,L,O,B){if(g.visible===!1)return;if(g.layers.test(L.layers)){if(g.isGroup)O=g.renderOrder;else if(g.isLOD)g.autoUpdate===!0&&g.update(L);else if(g.isLight)u.pushLight(g),g.castShadow&&u.pushShadow(g);else if(g.isSprite){if(!g.frustumCulled||We.intersectsSprite(g)){B&&Ce.setFromMatrixPosition(g.matrixWorld).applyMatrix4($);const fe=I.update(g),ve=g.material;ve.visible&&p.push(g,fe,ve,O,Ce.z,null)}}else if((g.isMesh||g.isLine||g.isPoints)&&(!g.frustumCulled||We.intersectsObject(g))){const fe=I.update(g),ve=g.material;if(B&&(g.boundingSphere!==void 0?(g.boundingSphere===null&&g.computeBoundingSphere(),Ce.copy(g.boundingSphere.center)):(fe.boundingSphere===null&&fe.computeBoundingSphere(),Ce.copy(fe.boundingSphere.center)),Ce.applyMatrix4(g.matrixWorld).applyMatrix4($)),Array.isArray(ve)){const pe=fe.groups;for(let we=0,Pe=pe.length;we<Pe;we++){const Ae=pe[we],ze=ve[Ae.materialIndex];ze&&ze.visible&&p.push(g,fe,ze,O,Ce.z,Ae)}}else ve.visible&&p.push(g,fe,ve,O,Ce.z,null)}}const ne=g.children;for(let fe=0,ve=ne.length;fe<ve;fe++)nr(ne[fe],L,O,B)}function Ns(g,L,O,B){const U=g.opaque,ne=g.transmissive,fe=g.transparent;u.setupLightsView(O),Be===!0&&ae.setGlobalState(T.clippingPlanes,O),B&&_e.viewport(C.copy(B)),U.length>0&&Mi(U,L,O),ne.length>0&&Mi(ne,L,O),fe.length>0&&Mi(fe,L,O),_e.buffers.depth.setTest(!0),_e.buffers.depth.setMask(!0),_e.buffers.color.setMask(!0),_e.setPolygonOffset(!1)}function Os(g,L,O,B){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[B.id]===void 0&&(u.state.transmissionRenderTarget[B.id]=new Ln(1,1,{generateMipmaps:!0,type:De.has("EXT_color_buffer_half_float")||De.has("EXT_color_buffer_float")?mi:en,minFilter:wn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ke.workingColorSpace}));const ne=u.state.transmissionRenderTarget[B.id],fe=B.viewport||C;ne.setSize(fe.z*T.transmissionResolutionScale,fe.w*T.transmissionResolutionScale);const ve=T.getRenderTarget(),pe=T.getActiveCubeFace(),we=T.getActiveMipmapLevel();T.setRenderTarget(ne),T.getClearColor(q),Y=T.getClearAlpha(),Y<1&&T.setClearColor(16777215,.5),T.clear(),Oe&&Se.render(O);const Pe=T.toneMapping;T.toneMapping=hn;const Ae=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),u.setupLightsView(B),Be===!0&&ae.setGlobalState(T.clippingPlanes,B),Mi(g,O,B),Ie.updateMultisampleRenderTarget(ne),Ie.updateRenderTargetMipmap(ne),De.has("WEBGL_multisampled_render_to_texture")===!1){let ze=!1;for(let Ze=0,st=L.length;Ze<st;Ze++){const tt=L[Ze],je=tt.object,be=tt.geometry,it=tt.material,Ve=tt.group;if(it.side===Jt&&je.layers.test(B.layers)){const Et=it.side;it.side=Mt,it.needsUpdate=!0,Bs(je,O,B,be,it,Ve),it.side=Et,it.needsUpdate=!0,ze=!0}}ze===!0&&(Ie.updateMultisampleRenderTarget(ne),Ie.updateRenderTargetMipmap(ne))}T.setRenderTarget(ve,pe,we),T.setClearColor(q,Y),Ae!==void 0&&(B.viewport=Ae),T.toneMapping=Pe}function Mi(g,L,O){const B=L.isScene===!0?L.overrideMaterial:null;for(let U=0,ne=g.length;U<ne;U++){const fe=g[U],ve=fe.object,pe=fe.geometry,we=fe.group;let Pe=fe.material;Pe.allowOverride===!0&&B!==null&&(Pe=B),ve.layers.test(O.layers)&&Bs(ve,L,O,pe,Pe,we)}}function Bs(g,L,O,B,U,ne){g.onBeforeRender(T,L,O,B,U,ne),g.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,g.matrixWorld),g.normalMatrix.getNormalMatrix(g.modelViewMatrix),U.onBeforeRender(T,L,O,B,g,ne),U.transparent===!0&&U.side===Jt&&U.forceSinglePass===!1?(U.side=Mt,U.needsUpdate=!0,T.renderBufferDirect(O,L,B,U,g,ne),U.side=dn,U.needsUpdate=!0,T.renderBufferDirect(O,L,B,U,g,ne),U.side=Jt):T.renderBufferDirect(O,L,B,U,g,ne),g.onAfterRender(T,L,O,B,U,ne)}function Si(g,L,O){L.isScene!==!0&&(L=Ee);const B=ge.get(g),U=u.state.lights,ne=u.state.shadowsArray,fe=U.state.version,ve=W.getParameters(g,U.state,ne,L,O),pe=W.getProgramCacheKey(ve);let we=B.programs;B.environment=g.isMeshStandardMaterial?L.environment:null,B.fog=L.fog,B.envMap=(g.isMeshStandardMaterial?nt:et).get(g.envMap||B.environment),B.envMapRotation=B.environment!==null&&g.envMap===null?L.environmentRotation:g.envMapRotation,we===void 0&&(g.addEventListener("dispose",K),we=new Map,B.programs=we);let Pe=we.get(pe);if(Pe!==void 0){if(B.currentProgram===Pe&&B.lightsStateVersion===fe)return Gs(g,ve),Pe}else ve.uniforms=W.getUniforms(g),g.onBeforeCompile(ve,T),Pe=W.acquireProgram(ve,pe),we.set(pe,Pe),B.uniforms=ve.uniforms;const Ae=B.uniforms;return(!g.isShaderMaterial&&!g.isRawShaderMaterial||g.clipping===!0)&&(Ae.clippingPlanes=ae.uniform),Gs(g,ve),B.needsLights=go(g),B.lightsStateVersion=fe,B.needsLights&&(Ae.ambientLightColor.value=U.state.ambient,Ae.lightProbe.value=U.state.probe,Ae.directionalLights.value=U.state.directional,Ae.directionalLightShadows.value=U.state.directionalShadow,Ae.spotLights.value=U.state.spot,Ae.spotLightShadows.value=U.state.spotShadow,Ae.rectAreaLights.value=U.state.rectArea,Ae.ltc_1.value=U.state.rectAreaLTC1,Ae.ltc_2.value=U.state.rectAreaLTC2,Ae.pointLights.value=U.state.point,Ae.pointLightShadows.value=U.state.pointShadow,Ae.hemisphereLights.value=U.state.hemi,Ae.directionalShadowMap.value=U.state.directionalShadowMap,Ae.directionalShadowMatrix.value=U.state.directionalShadowMatrix,Ae.spotShadowMap.value=U.state.spotShadowMap,Ae.spotLightMatrix.value=U.state.spotLightMatrix,Ae.spotLightMap.value=U.state.spotLightMap,Ae.pointShadowMap.value=U.state.pointShadowMap,Ae.pointShadowMatrix.value=U.state.pointShadowMatrix),B.currentProgram=Pe,B.uniformsList=null,Pe}function zs(g){if(g.uniformsList===null){const L=g.currentProgram.getUniforms();g.uniformsList=Ki.seqWithValue(L.seq,g.uniforms)}return g.uniformsList}function Gs(g,L){const O=ge.get(g);O.outputColorSpace=L.outputColorSpace,O.batching=L.batching,O.batchingColor=L.batchingColor,O.instancing=L.instancing,O.instancingColor=L.instancingColor,O.instancingMorph=L.instancingMorph,O.skinning=L.skinning,O.morphTargets=L.morphTargets,O.morphNormals=L.morphNormals,O.morphColors=L.morphColors,O.morphTargetsCount=L.morphTargetsCount,O.numClippingPlanes=L.numClippingPlanes,O.numIntersection=L.numClipIntersection,O.vertexAlphas=L.vertexAlphas,O.vertexTangents=L.vertexTangents,O.toneMapping=L.toneMapping}function mo(g,L,O,B,U){L.isScene!==!0&&(L=Ee),Ie.resetTextureUnits();const ne=L.fog,fe=B.isMeshStandardMaterial?L.environment:null,ve=F===null?T.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Qn,pe=(B.isMeshStandardMaterial?nt:et).get(B.envMap||fe),we=B.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,Pe=!!O.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Ae=!!O.morphAttributes.position,ze=!!O.morphAttributes.normal,Ze=!!O.morphAttributes.color;let st=hn;B.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(st=T.toneMapping);const tt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,je=tt!==void 0?tt.length:0,be=ge.get(B),it=u.state.lights;if(Be===!0&&(k===!0||g!==x)){const _t=g===x&&B.id===S;ae.setState(B,g,_t)}let Ve=!1;B.version===be.__version?(be.needsLights&&be.lightsStateVersion!==it.state.version||be.outputColorSpace!==ve||U.isBatchedMesh&&be.batching===!1||!U.isBatchedMesh&&be.batching===!0||U.isBatchedMesh&&be.batchingColor===!0&&U.colorTexture===null||U.isBatchedMesh&&be.batchingColor===!1&&U.colorTexture!==null||U.isInstancedMesh&&be.instancing===!1||!U.isInstancedMesh&&be.instancing===!0||U.isSkinnedMesh&&be.skinning===!1||!U.isSkinnedMesh&&be.skinning===!0||U.isInstancedMesh&&be.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&be.instancingColor===!1&&U.instanceColor!==null||U.isInstancedMesh&&be.instancingMorph===!0&&U.morphTexture===null||U.isInstancedMesh&&be.instancingMorph===!1&&U.morphTexture!==null||be.envMap!==pe||B.fog===!0&&be.fog!==ne||be.numClippingPlanes!==void 0&&(be.numClippingPlanes!==ae.numPlanes||be.numIntersection!==ae.numIntersection)||be.vertexAlphas!==we||be.vertexTangents!==Pe||be.morphTargets!==Ae||be.morphNormals!==ze||be.morphColors!==Ze||be.toneMapping!==st||be.morphTargetsCount!==je)&&(Ve=!0):(Ve=!0,be.__version=B.version);let Et=be.currentProgram;Ve===!0&&(Et=Si(B,L,U));let Un=!1,Tt=!1,ii=!1;const rt=Et.getUniforms(),wt=be.uniforms;if(_e.useProgram(Et.program)&&(Un=!0,Tt=!0,ii=!0),B.id!==S&&(S=B.id,Tt=!0),Un||x!==g){_e.buffers.depth.getReversed()&&g.reversedDepth!==!0&&(g._reversedDepth=!0,g.updateProjectionMatrix()),rt.setValue(y,"projectionMatrix",g.projectionMatrix),rt.setValue(y,"viewMatrix",g.matrixWorldInverse);const vt=rt.map.cameraPosition;vt!==void 0&&vt.setValue(y,de.setFromMatrixPosition(g.matrixWorld)),Re.logarithmicDepthBuffer&&rt.setValue(y,"logDepthBufFC",2/(Math.log(g.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&rt.setValue(y,"isOrthographic",g.isOrthographicCamera===!0),x!==g&&(x=g,Tt=!0,ii=!0)}if(U.isSkinnedMesh){rt.setOptional(y,U,"bindMatrix"),rt.setOptional(y,U,"bindMatrixInverse");const _t=U.skeleton;_t&&(_t.boneTexture===null&&_t.computeBoneTexture(),rt.setValue(y,"boneTexture",_t.boneTexture,Ie))}U.isBatchedMesh&&(rt.setOptional(y,U,"batchingTexture"),rt.setValue(y,"batchingTexture",U._matricesTexture,Ie),rt.setOptional(y,U,"batchingIdTexture"),rt.setValue(y,"batchingIdTexture",U._indirectTexture,Ie),rt.setOptional(y,U,"batchingColorTexture"),U._colorsTexture!==null&&rt.setValue(y,"batchingColorTexture",U._colorsTexture,Ie));const Ct=O.morphAttributes;if((Ct.position!==void 0||Ct.normal!==void 0||Ct.color!==void 0)&&ee.update(U,O,Et),(Tt||be.receiveShadow!==U.receiveShadow)&&(be.receiveShadow=U.receiveShadow,rt.setValue(y,"receiveShadow",U.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(wt.envMap.value=pe,wt.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&L.environment!==null&&(wt.envMapIntensity.value=L.environmentIntensity),Tt&&(rt.setValue(y,"toneMappingExposure",T.toneMappingExposure),be.needsLights&&_o(wt,ii),ne&&B.fog===!0&&J.refreshFogUniforms(wt,ne),J.refreshMaterialUniforms(wt,B,G,re,u.state.transmissionRenderTarget[g.id]),Ki.upload(y,zs(be),wt,Ie)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ki.upload(y,zs(be),wt,Ie),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&rt.setValue(y,"center",U.center),rt.setValue(y,"modelViewMatrix",U.modelViewMatrix),rt.setValue(y,"normalMatrix",U.normalMatrix),rt.setValue(y,"modelMatrix",U.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){const _t=B.uniformsGroups;for(let vt=0,ir=_t.length;vt<ir;vt++){const _n=_t[vt];ye.update(_n,Et),ye.bind(_n,Et)}}return Et}function _o(g,L){g.ambientLightColor.needsUpdate=L,g.lightProbe.needsUpdate=L,g.directionalLights.needsUpdate=L,g.directionalLightShadows.needsUpdate=L,g.pointLights.needsUpdate=L,g.pointLightShadows.needsUpdate=L,g.spotLights.needsUpdate=L,g.spotLightShadows.needsUpdate=L,g.rectAreaLights.needsUpdate=L,g.hemisphereLights.needsUpdate=L}function go(g){return g.isMeshLambertMaterial||g.isMeshToonMaterial||g.isMeshPhongMaterial||g.isMeshStandardMaterial||g.isShadowMaterial||g.isShaderMaterial&&g.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(g,L,O){const B=ge.get(g);B.__autoAllocateDepthBuffer=g.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),ge.get(g.texture).__webglTexture=L,ge.get(g.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:O,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(g,L){const O=ge.get(g);O.__webglFramebuffer=L,O.__useDefaultFramebuffer=L===void 0};const vo=y.createFramebuffer();this.setRenderTarget=function(g,L=0,O=0){F=g,w=L,D=O;let B=!0,U=null,ne=!1,fe=!1;if(g){const pe=ge.get(g);if(pe.__useDefaultFramebuffer!==void 0)_e.bindFramebuffer(y.FRAMEBUFFER,null),B=!1;else if(pe.__webglFramebuffer===void 0)Ie.setupRenderTarget(g);else if(pe.__hasExternalTextures)Ie.rebindTextures(g,ge.get(g.texture).__webglTexture,ge.get(g.depthTexture).__webglTexture);else if(g.depthBuffer){const Ae=g.depthTexture;if(pe.__boundDepthTexture!==Ae){if(Ae!==null&&ge.has(Ae)&&(g.width!==Ae.image.width||g.height!==Ae.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Ie.setupDepthRenderbuffer(g)}}const we=g.texture;(we.isData3DTexture||we.isDataArrayTexture||we.isCompressedArrayTexture)&&(fe=!0);const Pe=ge.get(g).__webglFramebuffer;g.isWebGLCubeRenderTarget?(Array.isArray(Pe[L])?U=Pe[L][O]:U=Pe[L],ne=!0):g.samples>0&&Ie.useMultisampledRTT(g)===!1?U=ge.get(g).__webglMultisampledFramebuffer:Array.isArray(Pe)?U=Pe[O]:U=Pe,C.copy(g.viewport),z.copy(g.scissor),V=g.scissorTest}else C.copy(oe).multiplyScalar(G).floor(),z.copy(Le).multiplyScalar(G).floor(),V=He;if(O!==0&&(U=vo),_e.bindFramebuffer(y.FRAMEBUFFER,U)&&B&&_e.drawBuffers(g,U),_e.viewport(C),_e.scissor(z),_e.setScissorTest(V),ne){const pe=ge.get(g.texture);y.framebufferTexture2D(y.FRAMEBUFFER,y.COLOR_ATTACHMENT0,y.TEXTURE_CUBE_MAP_POSITIVE_X+L,pe.__webglTexture,O)}else if(fe){const pe=L;for(let we=0;we<g.textures.length;we++){const Pe=ge.get(g.textures[we]);y.framebufferTextureLayer(y.FRAMEBUFFER,y.COLOR_ATTACHMENT0+we,Pe.__webglTexture,O,pe)}}else if(g!==null&&O!==0){const pe=ge.get(g.texture);y.framebufferTexture2D(y.FRAMEBUFFER,y.COLOR_ATTACHMENT0,y.TEXTURE_2D,pe.__webglTexture,O)}S=-1},this.readRenderTargetPixels=function(g,L,O,B,U,ne,fe,ve=0){if(!(g&&g.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let pe=ge.get(g).__webglFramebuffer;if(g.isWebGLCubeRenderTarget&&fe!==void 0&&(pe=pe[fe]),pe){_e.bindFramebuffer(y.FRAMEBUFFER,pe);try{const we=g.textures[ve],Pe=we.format,Ae=we.type;if(!Re.textureFormatReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Re.textureTypeReadable(Ae)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=g.width-B&&O>=0&&O<=g.height-U&&(g.textures.length>1&&y.readBuffer(y.COLOR_ATTACHMENT0+ve),y.readPixels(L,O,B,U,ce.convert(Pe),ce.convert(Ae),ne))}finally{const we=F!==null?ge.get(F).__webglFramebuffer:null;_e.bindFramebuffer(y.FRAMEBUFFER,we)}}},this.readRenderTargetPixelsAsync=async function(g,L,O,B,U,ne,fe,ve=0){if(!(g&&g.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let pe=ge.get(g).__webglFramebuffer;if(g.isWebGLCubeRenderTarget&&fe!==void 0&&(pe=pe[fe]),pe)if(L>=0&&L<=g.width-B&&O>=0&&O<=g.height-U){_e.bindFramebuffer(y.FRAMEBUFFER,pe);const we=g.textures[ve],Pe=we.format,Ae=we.type;if(!Re.textureFormatReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Re.textureTypeReadable(Ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ze=y.createBuffer();y.bindBuffer(y.PIXEL_PACK_BUFFER,ze),y.bufferData(y.PIXEL_PACK_BUFFER,ne.byteLength,y.STREAM_READ),g.textures.length>1&&y.readBuffer(y.COLOR_ATTACHMENT0+ve),y.readPixels(L,O,B,U,ce.convert(Pe),ce.convert(Ae),0);const Ze=F!==null?ge.get(F).__webglFramebuffer:null;_e.bindFramebuffer(y.FRAMEBUFFER,Ze);const st=y.fenceSync(y.SYNC_GPU_COMMANDS_COMPLETE,0);return y.flush(),await hl(y,st,4),y.bindBuffer(y.PIXEL_PACK_BUFFER,ze),y.getBufferSubData(y.PIXEL_PACK_BUFFER,0,ne),y.deleteBuffer(ze),y.deleteSync(st),ne}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(g,L=null,O=0){const B=Math.pow(2,-O),U=Math.floor(g.image.width*B),ne=Math.floor(g.image.height*B),fe=L!==null?L.x:0,ve=L!==null?L.y:0;Ie.setTexture2D(g,0),y.copyTexSubImage2D(y.TEXTURE_2D,O,0,0,fe,ve,U,ne),_e.unbindTexture()};const xo=y.createFramebuffer(),Mo=y.createFramebuffer();this.copyTextureToTexture=function(g,L,O=null,B=null,U=0,ne=null){ne===null&&(U!==0?(pi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ne=U,U=0):ne=0);let fe,ve,pe,we,Pe,Ae,ze,Ze,st;const tt=g.isCompressedTexture?g.mipmaps[ne]:g.image;if(O!==null)fe=O.max.x-O.min.x,ve=O.max.y-O.min.y,pe=O.isBox3?O.max.z-O.min.z:1,we=O.min.x,Pe=O.min.y,Ae=O.isBox3?O.min.z:0;else{const Ct=Math.pow(2,-U);fe=Math.floor(tt.width*Ct),ve=Math.floor(tt.height*Ct),g.isDataArrayTexture?pe=tt.depth:g.isData3DTexture?pe=Math.floor(tt.depth*Ct):pe=1,we=0,Pe=0,Ae=0}B!==null?(ze=B.x,Ze=B.y,st=B.z):(ze=0,Ze=0,st=0);const je=ce.convert(L.format),be=ce.convert(L.type);let it;L.isData3DTexture?(Ie.setTexture3D(L,0),it=y.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(Ie.setTexture2DArray(L,0),it=y.TEXTURE_2D_ARRAY):(Ie.setTexture2D(L,0),it=y.TEXTURE_2D),y.pixelStorei(y.UNPACK_FLIP_Y_WEBGL,L.flipY),y.pixelStorei(y.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),y.pixelStorei(y.UNPACK_ALIGNMENT,L.unpackAlignment);const Ve=y.getParameter(y.UNPACK_ROW_LENGTH),Et=y.getParameter(y.UNPACK_IMAGE_HEIGHT),Un=y.getParameter(y.UNPACK_SKIP_PIXELS),Tt=y.getParameter(y.UNPACK_SKIP_ROWS),ii=y.getParameter(y.UNPACK_SKIP_IMAGES);y.pixelStorei(y.UNPACK_ROW_LENGTH,tt.width),y.pixelStorei(y.UNPACK_IMAGE_HEIGHT,tt.height),y.pixelStorei(y.UNPACK_SKIP_PIXELS,we),y.pixelStorei(y.UNPACK_SKIP_ROWS,Pe),y.pixelStorei(y.UNPACK_SKIP_IMAGES,Ae);const rt=g.isDataArrayTexture||g.isData3DTexture,wt=L.isDataArrayTexture||L.isData3DTexture;if(g.isDepthTexture){const Ct=ge.get(g),_t=ge.get(L),vt=ge.get(Ct.__renderTarget),ir=ge.get(_t.__renderTarget);_e.bindFramebuffer(y.READ_FRAMEBUFFER,vt.__webglFramebuffer),_e.bindFramebuffer(y.DRAW_FRAMEBUFFER,ir.__webglFramebuffer);for(let _n=0;_n<pe;_n++)rt&&(y.framebufferTextureLayer(y.READ_FRAMEBUFFER,y.COLOR_ATTACHMENT0,ge.get(g).__webglTexture,U,Ae+_n),y.framebufferTextureLayer(y.DRAW_FRAMEBUFFER,y.COLOR_ATTACHMENT0,ge.get(L).__webglTexture,ne,st+_n)),y.blitFramebuffer(we,Pe,fe,ve,ze,Ze,fe,ve,y.DEPTH_BUFFER_BIT,y.NEAREST);_e.bindFramebuffer(y.READ_FRAMEBUFFER,null),_e.bindFramebuffer(y.DRAW_FRAMEBUFFER,null)}else if(U!==0||g.isRenderTargetTexture||ge.has(g)){const Ct=ge.get(g),_t=ge.get(L);_e.bindFramebuffer(y.READ_FRAMEBUFFER,xo),_e.bindFramebuffer(y.DRAW_FRAMEBUFFER,Mo);for(let vt=0;vt<pe;vt++)rt?y.framebufferTextureLayer(y.READ_FRAMEBUFFER,y.COLOR_ATTACHMENT0,Ct.__webglTexture,U,Ae+vt):y.framebufferTexture2D(y.READ_FRAMEBUFFER,y.COLOR_ATTACHMENT0,y.TEXTURE_2D,Ct.__webglTexture,U),wt?y.framebufferTextureLayer(y.DRAW_FRAMEBUFFER,y.COLOR_ATTACHMENT0,_t.__webglTexture,ne,st+vt):y.framebufferTexture2D(y.DRAW_FRAMEBUFFER,y.COLOR_ATTACHMENT0,y.TEXTURE_2D,_t.__webglTexture,ne),U!==0?y.blitFramebuffer(we,Pe,fe,ve,ze,Ze,fe,ve,y.COLOR_BUFFER_BIT,y.NEAREST):wt?y.copyTexSubImage3D(it,ne,ze,Ze,st+vt,we,Pe,fe,ve):y.copyTexSubImage2D(it,ne,ze,Ze,we,Pe,fe,ve);_e.bindFramebuffer(y.READ_FRAMEBUFFER,null),_e.bindFramebuffer(y.DRAW_FRAMEBUFFER,null)}else wt?g.isDataTexture||g.isData3DTexture?y.texSubImage3D(it,ne,ze,Ze,st,fe,ve,pe,je,be,tt.data):L.isCompressedArrayTexture?y.compressedTexSubImage3D(it,ne,ze,Ze,st,fe,ve,pe,je,tt.data):y.texSubImage3D(it,ne,ze,Ze,st,fe,ve,pe,je,be,tt):g.isDataTexture?y.texSubImage2D(y.TEXTURE_2D,ne,ze,Ze,fe,ve,je,be,tt.data):g.isCompressedTexture?y.compressedTexSubImage2D(y.TEXTURE_2D,ne,ze,Ze,tt.width,tt.height,je,tt.data):y.texSubImage2D(y.TEXTURE_2D,ne,ze,Ze,fe,ve,je,be,tt);y.pixelStorei(y.UNPACK_ROW_LENGTH,Ve),y.pixelStorei(y.UNPACK_IMAGE_HEIGHT,Et),y.pixelStorei(y.UNPACK_SKIP_PIXELS,Un),y.pixelStorei(y.UNPACK_SKIP_ROWS,Tt),y.pixelStorei(y.UNPACK_SKIP_IMAGES,ii),ne===0&&L.generateMipmaps&&y.generateMipmap(it),_e.unbindTexture()},this.initRenderTarget=function(g){ge.get(g).__webglFramebuffer===void 0&&Ie.setupRenderTarget(g)},this.initTexture=function(g){g.isCubeTexture?Ie.setTextureCube(g,0):g.isData3DTexture?Ie.setTexture3D(g,0):g.isDataArrayTexture||g.isCompressedArrayTexture?Ie.setTexture2DArray(g,0):Ie.setTexture2D(g,0),_e.unbindTexture()},this.resetState=function(){w=0,D=0,F=null,_e.reset(),se.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Vt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}const Dd=`
...
`,Ud=({className:i,style:e,wispDensity:t=1,dpr:n,mouseSmoothTime:r=0,mouseTiltStrength:s=.01,horizontalBeamOffset:a=.1,verticalBeamOffset:o=0,flowSpeed:c=.35,verticalSizing:l=2,horizontalSizing:f=.5,fogIntensity:h=.45,fogScale:d=.3,wispSpeed:m=15,wispIntensity:v=5,flowStrength:M=.25,decay:p=1.1,falloffStart:u=1.2,fogFallSpeed:R=.6,color:A="#FF79C6",backgroundColor:T="#000000"})=>{const P=mt.useRef(null),w=mt.useRef(null),D=mt.useRef(null),F=mt.useRef(!1),S=mt.useRef(null),x=mt.useRef(1),C=mt.useRef(1),z=mt.useRef({width:0,height:0,dpr:0}),V=mt.useRef([]),q=mt.useRef(performance.now()),Y=mt.useRef(16.7),X=mt.useRef(!1),re=mt.useRef(!0),G=Z=>{let ie=Z.trim();ie[0]==="#"&&(ie=ie.slice(1)),ie.length===3&&(ie=ie.split("").map(Le=>Le+Le).join(""));const oe=parseInt(ie.slice(0,6),16)||16777215;return{r:(oe>>16&255)/255,g:(oe>>8&255)/255,b:(oe&255)/255}};return mt.useEffect(()=>{const Z=P.current,ie=new Pd({antialias:!1,alpha:!1,depth:!1,stencil:!1,powerPreference:"high-performance",premultipliedAlpha:!1,preserveDrawingBuffer:!1,failIfMajorPerformanceCaveat:!1,logarithmicDepthBuffer:!1});w.current=ie,x.current=Math.min(n??(window.devicePixelRatio||1),2),C.current=x.current,ie.setPixelRatio(C.current),ie.shadowMap.enabled=!1,ie.outputColorSpace=bt,ie.setClearColor(0,1);const oe=ie.domElement;oe.style.width="100%",oe.style.height="100%",oe.style.display="block",(j=>{const he=new qe(j||"#000000"),se=he.r*.2126+he.g*.7152+he.b*.0722>.72;Z.style.backgroundColor=j||"#000000",oe.style.filter=se?"invert(1) hue-rotate(180deg)":"none",oe.style.mixBlendMode=se?"normal":"screen"})(T),Z.appendChild(oe);const He=new Bl,We=new lo(-1,1,1,-1,0,1),Be=new pn;Be.setAttribute("position",new Bt(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));const k={iTime:{value:0},iResolution:{value:new N(1,1,1)},iMouse:{value:new at(0,0,0,0)},uWispDensity:{value:t},uTiltScale:{value:s},uFlowTime:{value:0},uFogTime:{value:0},uBeamXFrac:{value:a},uBeamYFrac:{value:o},uFlowSpeed:{value:c},uVLenFactor:{value:l},uHLenFactor:{value:f},uFogIntensity:{value:h},uFogScale:{value:d},uWSpeed:{value:m},uWIntensity:{value:v},uFlowStrength:{value:M},uDecay:{value:p},uFalloffStart:{value:u},uFogFallSpeed:{value:R},uColor:{value:new N(1,1,1)},uFade:{value:F.current?1:0}};D.current=k;const $=new Vl({vertexShader:Dd,fragmentShader:Ld,uniforms:k,transparent:!1,depthTest:!1,depthWrite:!1,blending:Cn}),de=new kt(Be,$);de.frustumCulled=!1,He.add(de);const Ce=new ql;let Ee=0,Oe=F.current?1:0;const ot=new Ye(0,0),y=new Ye(0,0),Ke=()=>{const j=Z.clientWidth||1,he=Z.clientHeight||1,ce=C.current,se=z.current,ye=Math.abs(j-se.width)>.5||Math.abs(he-se.height)>.5,b=Math.abs(ce-se.dpr)>.01;!ye&&!b||(z.current={width:j,height:he,dpr:ce},ie.setPixelRatio(ce),ie.setSize(j,he,!1),k.iResolution.value.set(j*ce,he*ce,ce),S.current=oe.getBoundingClientRect(),X.current||ie.render(He,We))};let De=0;const Re=()=>{De&&cancelAnimationFrame(De),De=requestAnimationFrame(Ke)};Ke();const _e=new ResizeObserver(Re);_e.observe(Z);const Je=new IntersectionObserver(j=>{var he;re.current=((he=j[0])==null?void 0:he.isIntersecting)??!0},{root:null,threshold:0});Je.observe(Z);const ge=()=>{X.current=document.hidden};document.addEventListener("visibilitychange",ge,{passive:!0});const Ie=(j,he)=>{const ce=S.current;if(!ce)return;const se=j-ce.left,ye=he-ce.top,b=C.current,Q=ce.height*b;ot.set(se*b,Q-ye*b)},et=j=>Ie(j.clientX,j.clientY),nt=()=>ot.set(0,0);oe.addEventListener("pointermove",et,{passive:!0}),oe.addEventListener("pointerdown",et,{passive:!0}),oe.addEventListener("pointerenter",et,{passive:!0}),oe.addEventListener("pointerleave",nt,{passive:!0});const E=j=>{j.preventDefault(),X.current=!0},_=()=>{X.current=!1,Re()};oe.addEventListener("webglcontextlost",E,!1),oe.addEventListener("webglcontextrestored",_,!1);let I=0;const W=(j,he,ce)=>Math.max(he,Math.min(ce,j)),J=.6,H=50,Te=58;let ae=0;const xe=2e3,Se=j=>{if(j-q.current<750)return;const ce=V.current;if(ce.length===0){q.current=j;return}const se=ce.reduce((Q,le)=>Q+le,0)/ce.length;let ye=C.current;const b=x.current;se<H?ye=W(C.current*.85,J,b):se>Te&&C.current<b&&(ye=W(C.current*1.1,J,b)),Math.abs(ye-C.current)>.01&&j-ae>xe&&(C.current=ye,ae=j,Ke()),V.current=[],q.current=j},ee=()=>{if(I=requestAnimationFrame(ee),X.current||!re.current)return;const j=Ce.getElapsedTime(),he=Math.max(0,j-Ee);Ee=j;const ce=he*1e3;Y.current=Y.current*.9+ce*.1;const se=1e3/Math.max(1,Y.current);V.current.push(se),k.iTime.value=j;const ye=Math.min(.033,Math.max(.001,he));k.uFlowTime.value+=ye,k.uFogTime.value+=ye,F.current||(Oe=Math.min(1,Oe+ye/1),k.uFade.value=Oe,Oe>=1&&(F.current=!0));const b=Math.max(.001,r),Q=1-Math.exp(-ye/b);y.lerp(ot,Q),k.iMouse.value.set(y.x,y.y,0,0),ie.render(He,We),Se(performance.now())};return ee(),()=>{cancelAnimationFrame(I),_e.disconnect(),Je.disconnect(),document.removeEventListener("visibilitychange",ge),oe.removeEventListener("pointermove",et),oe.removeEventListener("pointerdown",et),oe.removeEventListener("pointerenter",et),oe.removeEventListener("pointerleave",nt),oe.removeEventListener("webglcontextlost",E),oe.removeEventListener("webglcontextrestored",_),Be.dispose(),$.dispose(),ie.dispose(),ie.forceContextLoss(),Z.contains(oe)&&Z.removeChild(oe)}},[n]),mt.useEffect(()=>{var We;const Z=D.current;if(!Z)return;Z.uWispDensity.value=t,Z.uTiltScale.value=s,Z.uBeamXFrac.value=a,Z.uBeamYFrac.value=o,Z.uFlowSpeed.value=c,Z.uVLenFactor.value=l,Z.uHLenFactor.value=f,Z.uFogIntensity.value=h,Z.uFogScale.value=d,Z.uWSpeed.value=m,Z.uWIntensity.value=v,Z.uFlowStrength.value=M,Z.uDecay.value=p,Z.uFalloffStart.value=u,Z.uFogFallSpeed.value=R;const{r:ie,g:oe,b:Le}=G(A||"#FFFFFF");Z.uColor.value.set(ie,oe,Le);const He=(We=w.current)==null?void 0:We.domElement;if(He){const Be=new qe(T||"#000000"),$=Be.r*.2126+Be.g*.7152+Be.b*.0722>.72,de=P.current;de&&(de.style.backgroundColor=T||"#000000"),He.style.filter=$?"invert(1) hue-rotate(180deg)":"none",He.style.mixBlendMode=$?"normal":"screen"}},[t,s,a,o,c,l,f,h,d,m,v,M,p,u,R,A,T]),Fr.jsx("div",{ref:P,className:`laser-flow-container ${i||""}`,style:e})},Na=document.getElementById("cta-laserflow");Na&&So.createRoot(Na).render(Fr.jsx(mt.StrictMode,{children:Fr.jsx(Ud,{color:"#FFB900",wispDensity:1,flowSpeed:.35,verticalSizing:2,horizontalSizing:.5,fogIntensity:.45,fogScale:.3,wispSpeed:15,wispIntensity:5,flowStrength:.25,decay:1.1,horizontalBeamOffset:.05,verticalBeamOffset:-.5,backgroundColor:"#171717"})}));
