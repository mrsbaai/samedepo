...
- **TRC20 gas at real cost (planned)** — TRC20 settlement is being moved to real-cost on-chain fee estimation, right-sized gas top-ups, automatic stranded-gas recovery, and rented TRON energy (TronSave) with automatic burn fallback — with no staked or locked capital (Feature 022).
